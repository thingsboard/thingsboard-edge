...
public class ThingsboardCoapIntegrationApplication {
    ...
    private static final String DEFAULT_SPRING_CONFIG_PARAM = SPRING_CONFIG_NAME_KEY + "=" + "tb-coap-integration";

    public static void main(String[] args) {
        SpringApplication.run(ThingsboardCoapIntegrationApplication.class, updateArguments(args));
    }
