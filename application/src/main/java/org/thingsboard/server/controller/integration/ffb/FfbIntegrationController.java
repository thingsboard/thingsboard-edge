 ...
 */
package org.thingsboard.server.controller.integration.ffb;
...
@RestController
@RequestMapping("/api/v1/integrations/ffb")
@Slf4j
public class FfbIntegrationController extends BaseIntegrationController {
    ...
    public DeferredResult<ResponseEntity> processRequest(
        ...
        if (integration.get().getConfiguration().getType() != IntegrationType.FFB) {
