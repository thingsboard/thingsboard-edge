...
@Data
public class EntityTypeExportCtx extends BasicExportCtx {


    private final EntityType entityType;
    private final boolean overwrite;
    private final EntityTypeVersionCreateConfig config;
    @Getter(value = AccessLevel.PRIVATE)
    private final Queue<EntityTypeExportTask> tasks;

    public EntityTypeExportCtx(SecurityUser user, CommitGitRequest commit, List<ListenableFuture<Void>> futures, EntityTypeVersionCreateConfig config, SyncStrategy defaultSyncStrategy, EntityType entityType) {
        super(user, commit, futures, EntityExportSettings.builder()
