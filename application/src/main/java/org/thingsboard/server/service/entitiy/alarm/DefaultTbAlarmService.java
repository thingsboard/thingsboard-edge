...
public class DefaultTbAlarmService extends AbstractTbEntityService implements TbAlarmService {
    ...
    public Alarm save(Alarm alarm, User user) throws ThingsboardException {
        ...
        try {
            ...
            if (result.isModified()) {
                notificationEntityService.notifyCreateOrUpdateAlarm(result.getAlarm(), actionType, user, true);
            }
    ...
    public AlarmInfo ack(Alarm alarm, long ackTs, User user) throws ThingsboardException {
        ...
        if (result.isModified()) {
            ...
            notificationEntityService.notifyCreateOrUpdateAlarm(result.getAlarm(), ActionType.ALARM_ACK, user, true);
        } else {
    ...
    public AlarmInfo clear(Alarm alarm, long clearTs, User user) throws ThingsboardException {
        ...
        if (result.isCleared()) {
            ...
            notificationEntityService.notifyCreateOrUpdateAlarm(result.getAlarm(), ActionType.ALARM_CLEAR, user, true);
        } else {
    ...
    public AlarmInfo assign(Alarm alarm, UserId assigneeId, long assignTs, User user) throws ThingsboardException {
        ...
        if (result.isModified()) {
            ...
            notificationEntityService.notifyCreateOrUpdateAlarm(result.getAlarm(), ActionType.ALARM_ASSIGN, user, true);
        } else {
    ...
    public AlarmInfo unassign(Alarm alarm, long unassignTs, User user) throws ThingsboardException {
        ...
        if (result.isModified()) {
            ...
            notificationEntityService.notifyCreateOrUpdateAlarm(result.getAlarm(), ActionType.ALARM_UNASSIGN, user, true);
        } else {
