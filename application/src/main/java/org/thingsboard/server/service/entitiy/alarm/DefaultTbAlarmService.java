...
public class DefaultTbAlarmService extends AbstractTbEntityService implements TbAlarmService {
    ...
    public Alarm save(Alarm alarm, User user) throws ThingsboardException {
        ...
        try {
            ...
            notificationEntityService.notifyCreateOrUpdateAlarm(savedAlarm, actionType, user, true);
            return savedAlarm;
        } catch (Exception e) {
    ...
    public ListenableFuture<Void> ack(Alarm alarm, User user) {
        ...
        return Futures.transform(future, result -> {
            ...
            notificationEntityService.notifyCreateOrUpdateAlarm(alarm, ActionType.ALARM_ACK, user, true);
            return null;
    ...
    public ListenableFuture<Void> clear(Alarm alarm, User user) {
        ...
        return Futures.transform(future, result -> {
            ...
            notificationEntityService.notifyCreateOrUpdateAlarm(alarm, ActionType.ALARM_CLEAR, user, true);
            return null;
        }, MoreExecutors.directExecutor());
    }
