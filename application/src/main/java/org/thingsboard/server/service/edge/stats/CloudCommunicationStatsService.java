...
public class CloudCommunicationStatsService {
    ...
    public void reportStats() {
        ...
        try {
            ...
            cloudEventService.saveTsKvAsync(cloudEvent);
    ...
    private void updateLagIfKafkaEnabled() {
        if (tbKafkaAdmin != null) {
            ...
            Map<String, Long> groupIdToLag = tbKafkaAdmin.getTotalLagForGroupsBulk(groupIds);
            ...
            statsCounterService.setUplinkMsgsLag(lagCloudEvent + lagCloudEventTs);
        }
    }
