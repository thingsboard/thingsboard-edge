...
@Slf4j
@Service
public class DefaultUserLoaderService implements UserLoaderService {
    ...
    @Override
    public void createUser(Authority authority, TenantId tenantId, CustomerId customerId, String email, String password) {
        User user = new User();
        ...
        if (authority == Authority.TENANT_ADMIN) {
            EntityGroup admins = entityGroupService.findOrCreateTenantUsersGroup(user.getTenantId());
