...
public interface GroupMsgConstructor extends MsgConstructor {
    ...
    EntityGroupUpdateMsg constructEntityGroupDeleteMsg(EntityGroupId entityGroupId);

    GroupPermissionProto constructGroupPermissionProto(UpdateMsgType msgType, GroupPermission groupPermission);

    GroupPermissionProto constructGroupPermissionDeleteMsg(GroupPermissionId groupPermissionId);
}
