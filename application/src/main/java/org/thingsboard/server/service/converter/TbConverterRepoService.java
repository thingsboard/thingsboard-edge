...
public class TbConverterRepoService {
     ...
     * @return [{"name": "Milesight", "info": {...}]
     * @throws ThingsboardException
     */
    public TbGitHubContent[] getIntegrationVendors(String pathDir, String integrationType) throws ThingsboardException {
        try {
     ...
     * @param integrationType
     * @param vendorName
     * @return  [{"name": "WS202", "info": {...}]
     * @throws ThingsboardException
     */
    public TbGitHubContent[] getVendorModels(String pathDir, String integrationType, String vendorName) throws ThingsboardException {
        try {
            String path = pathDir == null ? "VENDORS" : pathDir.startsWith("VENDORS") ? pathDir : "VENDORS" + "/" + pathDir;
            UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(converterGitHubUrl + path);
     ...
     * @throws ThingsboardException
     */
    public String getConverterUplink(String filePath, String integrationType, String model, String vendorName) throws ThingsboardException {
     ...
     * @throws ThingsboardException
     */
    public String getMetadataUplink(String filePath, String integrationType, String model, String vendorName) throws ThingsboardException {
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(converterGitHubUrl + filePath);
     ...
     * @throws ThingsboardException
     */
    public String getPayloadUplink(String filePath, String integrationType, String model, String vendorName) throws ThingsboardException {
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(converterGitHubUrl + filePath);
     ...
     * @throws ThingsboardException
     */
    public String getConverterDownlink(String filePath, String integrationType, String model, String vendorName) throws ThingsboardException {
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(converterGitHubUrl + filePath);
     ...
     * @throws ThingsboardException
     */
    public String getMetadataDownlink(String filePath, String integrationType, String model, String vendorName) throws ThingsboardException {
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(converterGitHubUrl + filePath);
     ...
     * @throws ThingsboardException
     */
    public String getPayloadDownlink(String filePath, String integrationType, String model, String vendorName) throws ThingsboardException {
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(converterGitHubUrl + filePath);
