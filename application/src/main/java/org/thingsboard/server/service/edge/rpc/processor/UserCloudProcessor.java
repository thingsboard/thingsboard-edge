...
public class UserCloudProcessor extends BaseCloudProcessor {
    ...
    public ListenableFuture<Void> processUserMsgFromCloud(TenantId tenantId, UserUpdateMsg userUpdateMsg, CloudType cloudType, UUID queueStartId) {
        ...
        ListenableFuture<Void> aDRF = Futures.transform(requestForAdditionalData(tenantId, userUpdateMsg.getMsgType(), userId, queueStartId), future -> null, dbCallbackExecutor);
