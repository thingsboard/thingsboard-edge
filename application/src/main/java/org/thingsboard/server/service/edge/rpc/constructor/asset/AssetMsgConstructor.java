...
public interface AssetMsgConstructor {

    AssetUpdateMsg constructAssetUpdatedMsg(UpdateMsgType msgType, Asset asset, EntityGroupId entityGroupId);

    AssetUpdateMsg constructAssetDeleteMsg(AssetId assetId, EntityGroupId entityGroupId);
