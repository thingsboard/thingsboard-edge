...
public class EntityViewCloudProcessor extends BaseEntityViewProcessor {
        ...
        try {
            ...
            return switch (entityViewUpdateMsg.getMsgType()) {
                case ENTITY_CREATED_RPC_MESSAGE, ENTITY_UPDATED_RPC_MESSAGE -> {
                    saveOrUpdateEntityViewOnCloud(tenantId, entityViewId, entityViewUpdateMsg);
    ...
    private void saveOrUpdateEntityViewOnCloud(TenantId tenantId, EntityViewId entityViewId, EntityViewUpdateMsg entityViewUpdateMsg) throws ThingsboardException {
