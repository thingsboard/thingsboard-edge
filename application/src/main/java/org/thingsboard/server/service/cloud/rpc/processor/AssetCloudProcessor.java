...
public class AssetCloudProcessor extends BaseAssetProcessor {
        ...
        try {
            ...
            return switch (assetUpdateMsg.getMsgType()) {
                case ENTITY_CREATED_RPC_MESSAGE, ENTITY_UPDATED_RPC_MESSAGE -> {
                    saveOrUpdateAssetOnCloud(tenantId, assetId, assetUpdateMsg);
    ...
    private void saveOrUpdateAssetOnCloud(TenantId tenantId, AssetId assetId, AssetUpdateMsg assetUpdateMsg) throws ThingsboardException {
