...
public class ResourceEdgeTest extends AbstractEdgeTest {
    ...
    public void testResources_create_update_delete() throws Exception {
        ...
        Assert.assertEquals("Edge Test Resource", resourceUpdateMsg.getTitle());
        Assert.assertEquals(ResourceType.JKS.name(), resourceUpdateMsg.getResourceType());
        Assert.assertEquals(FILE_NAME, resourceUpdateMsg.getResourceKey());
        Assert.assertEquals(FILE_NAME, resourceUpdateMsg.getFileName());
        Assert.assertEquals(TEST_DATA, resourceUpdateMsg.getData());
        Assert.assertTrue(StringUtils.isNotBlank(resourceUpdateMsg.getEtag()));
        ...
        Assert.assertEquals("Updated Edge Test Resource", resourceUpdateMsg.getTitle());
