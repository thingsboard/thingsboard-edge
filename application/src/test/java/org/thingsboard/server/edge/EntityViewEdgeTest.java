...
public class EntityViewEdgeTest extends AbstractEdgeTest {
    ...
    public void testSendEntityViewToCloud() throws Exception {
        ...
        AbstractMessage latestMessage = edgeImitator.getLatestMessage();
        Assert.assertTrue(latestMessage instanceof EntityViewUpdateMsg);
        EntityViewUpdateMsg latestEntityViewUpdateMsg = (EntityViewUpdateMsg) latestMessage;
        Assert.assertEquals(uuid.getMostSignificantBits(), latestEntityViewUpdateMsg.getIdMSB());
        Assert.assertEquals(uuid.getLeastSignificantBits(), latestEntityViewUpdateMsg.getIdLSB());
