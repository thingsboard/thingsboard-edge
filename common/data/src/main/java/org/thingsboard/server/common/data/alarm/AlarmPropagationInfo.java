...
public class AlarmPropagationInfo {
    ...
    @ApiModelProperty(position = 3, value = "Propagation flag to specify if alarm should be propagated to the owner hierarchy (customer hierarchy) of alarm originator", example = "true")
    private boolean propagateToOwnerHierarchy;
    @ApiModelProperty(position = 4, value = "Propagation flag to specify if alarm should be propagated to the tenant entity", example = "true")
    private boolean propagateToTenant;
    @NoXss
    @ApiModelProperty(position = 5, value = "JSON array of relation types that should be used for propagation. " +
