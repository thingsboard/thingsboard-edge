...
public class EntityGroup extends BaseData<EntityGroupId> implements HasName, HasOwnerId, ExportableNoTenantIdEntity<EntityGroupId> {
    ...
    @Schema(required = true, allowableValues = {"CUSTOMER", "ASSET", "DEVICE", "USER", "ENTITY_VIEW", "DASHBOARD", "EDGE"})
    private EntityType type;

    @Schema(required = true, description = "Name of the entity group", example = "Water meters")
    @NoXss
