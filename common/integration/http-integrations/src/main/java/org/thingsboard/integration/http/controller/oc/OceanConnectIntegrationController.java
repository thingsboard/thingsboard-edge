 ...
 */
package org.thingsboard.integration.http.controller.oc;
...
public class OceanConnectIntegrationController extends BaseIntegrationController {
    ...
    @Operation(description = "Process request from OceanConnect platform", hidden = true)
    ...
    public DeferredResult<ResponseEntity> processRequest(
        ...
        api.process(IntegrationType.OCEANCONNECT, routingKey, result, new JsonHttpIntegrationMsg(requestHeaders, msg, result));
