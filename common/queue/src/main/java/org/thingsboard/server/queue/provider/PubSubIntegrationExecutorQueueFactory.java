...
@Component
@ConditionalOnExpression("'${queue.type:null}'=='pubsub' && '${service.type:null}'=='tb-integration-executor'")
public class PubSubIntegrationExecutorQueueFactory implements TbIntegrationExecutorQueueFactory {
    ...
    public TbQueueProducer<TbProtoQueueMsg<ToCoreIntegrationMsg>> createTbCoreIntegrationMsgProducer() {
        return new TbPubSubProducerTemplate<>(coreAdmin, pubSubSettings, coreSettings.getIntegrationsTopic());
    }
