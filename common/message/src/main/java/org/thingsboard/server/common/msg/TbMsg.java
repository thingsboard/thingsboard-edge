...
public final class TbMsg implements Serializable {
    ...
    public static TbMsg newMsg(QueueId queueId, String type, EntityId originator, TbMsgMetaData metaData, TbMsgDataType dataType, String data) {
        return new TbMsg(queueId, UUID.randomUUID(), System.currentTimeMillis(), type, originator, null, metaData.copy(), dataType, data, null, null, null, TbMsgCallback.EMPTY);
    }
