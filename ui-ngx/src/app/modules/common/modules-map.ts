...
export const modulesMap: {[key: string]: any} = {
  ...
  '@angular/material/badge': SystemJS.new(AngularMaterialBadge),
  '@angular/material/bottom-sheet': SystemJS.new(AngularMaterialBottomSheet),
  '@angular/material/button': SystemJS.new(AngularMaterialButton),
  '@angular/material/button-toggle': SystemJS.new(AngularMaterialButtonToggle),
  '@angular/material/card': SystemJS.new(AngularMaterialCard),
  '@angular/material/checkbox': SystemJS.new(AngularMaterialCheckbox),
