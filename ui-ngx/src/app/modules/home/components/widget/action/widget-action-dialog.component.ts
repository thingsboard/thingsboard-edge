...
export class WidgetActionDialogComponent extends DialogComponent<WidgetActionDialogComponent,
  ...
  ngOnInit(): void {
    this.widgetActionFormGroup = this.fb.group({
      ...
      buttonFillColor: [{ value: this.action.buttonFillColor ?? 'var(-primary-color-500)', disabled: true}, []],
      buttonBorderColor: [{ value: this.action.buttonBorderColor ?? 'var(-primary-color-500)', disabled: true}, []],
