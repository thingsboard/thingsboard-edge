...
@Component({
  selector: 'tb-group-dashboard-form',
  templateUrl: './group-dashboard-form.component.html',
  styleUrls: ['./group-dashboard-form.component.scss']
})
export class GroupDashboardFormComponent extends GroupEntityComponent<Dashboard> {
