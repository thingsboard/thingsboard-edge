...
import { SolutionTemplateInfo, TenantSolutionTemplateInfo } from '@shared/models/solution-template.models';
...
export class SolutionTemplatesComponent extends PageComponent implements OnInit {
  ...
  solutionTemplates: Array<TenantSolutionTemplateInfo> = this.route.snapshot.data.solutionTemplates;
