...
export const docPlatformPrefix = DocPlatformPrefix.PE;
const docPlatformPrefixPE = DocPlatformPrefix.CE;
...
export const HelpLinks = {
  linksMap: {
    ...
    converters: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/#data-converters`,
    uplinkConverters: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/#uplink-data-converter`,
    downlinkConverters: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/#downlink-data-converter`,
    integrations: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations`,
    integrationHttp: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/http`,
    integrationOceanConnect: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/ocean-connect`,
    integrationSigFox: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/sigfox`,
    integrationThingPark: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/thingpark`,
    integrationThingParkEnterprise: `${helpBaseUrl}/docs${docPlatformPrefixPE}/samples/abeeway/tracker`,
    integrationTMobileIotCdp: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/t-mobile-iot-cdp`,
    integrationLoriot: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/loriot`,
    integrationParticle: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/particle`,
    integrationMqtt: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/mqtt`,
    integrationAwsIoT: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/aws-iot`,
    integrationAwsSQS: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/aws-sqs`,
    integrationAwsKinesis:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/aws-kinesis`,
    integrationIbmWatsonIoT: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/ibm-watson-iot`,
    integrationTheThingsNetwork: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/ttn`,
    integrationTheThingsIndustries: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/tti`,
    integrationChirpStack: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/chirpstack`,
    integrationAzureEventHub: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/azure-event-hub`,
    integrationAzureIoTHub: `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/azure-iot-hub`,
    integrationOpcUa:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/opc-ua`,
    integrationUdp:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/udp`,
    integrationTcp:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/tcp`,
    integrationKafka:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/kafka`,
    integrationRabbitmq:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/rabbitmq`,
    integrationApachePulsar:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/apache-pulsar`,
    integrationPubsub:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/pubsub`,
    integrationCoAP:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/coap`,
    integrationKpn:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/kpn`,
    integrationCustom:  `${helpBaseUrl}/docs${docPlatformPrefixPE}/user-guide/integrations/custom`,
    ...
    roles: `${helpBaseUrl}/docs${docPlatformPrefix}/user-guide/ui/roles`,
