...
export const HelpLinks = {
  linksMap: {
    ...
    widgetsConfig:  helpBaseUrl + '/docs/pe/user-guide/widgets',
    widgetsConfigTimeseries:  helpBaseUrl + '/docs/pe/user-guide/widgets',
    widgetsConfigLatest: helpBaseUrl +  '/docs/pe/user-guide/widgets',
    widgetsConfigRpc: helpBaseUrl +  '/docs/pe/user-guide/widgets',
    widgetsConfigAlarm: helpBaseUrl +  '/docs/pe/user-guide/widgets',
    widgetsConfigStatic: helpBaseUrl +  '/docs/pe/user-guide/widgets',
