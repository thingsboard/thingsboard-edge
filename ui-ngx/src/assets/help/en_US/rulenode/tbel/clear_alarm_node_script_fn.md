...
[TBEL{:target="_blank"}](${siteBaseUrl}/docs/pe/user-guide/tbel/) function generating **Alarm Details** object to update existing one. Used for storing additional parameters inside Alarm.<br>
