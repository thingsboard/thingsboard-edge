...
@RuleNode(
        ...
        relationTypes = {"Post attributes", "Post telemetry", "RPC Request from Device", "RPC Request to Device", "Activity Event", "Inactivity Event",
                ...
                "Entity Unassigned", "Attributes Updated", "Attributes Deleted", "Alarm Acknowledged", "Alarm Cleared",
                "Added to Group", "Removed from Group", "REST API request", "Generate Report", "Other",
                "Entity Assigned From Tenant", "Entity Assigned To Tenant"},
