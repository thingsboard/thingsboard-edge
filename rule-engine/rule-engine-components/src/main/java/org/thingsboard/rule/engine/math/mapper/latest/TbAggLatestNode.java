...
@RuleNode(
        ...
        configClazz = TbAggLatestNodeConfiguration.class,
        ...
        configDirective = "tbActionNodeAggregateLatestConfig",
        icon = "functions"
)

public class TbAggLatestNode extends TbAbstractMapperNode<TbAggLatestNodeConfiguration> {
    ...
    @Override
    protected TbAggLatestNodeConfiguration loadMapperNodeConfig(TbNodeConfiguration configuration) throws TbNodeException {
        return TbNodeUtils.convert(configuration, TbAggLatestNodeConfiguration.class);
    }
