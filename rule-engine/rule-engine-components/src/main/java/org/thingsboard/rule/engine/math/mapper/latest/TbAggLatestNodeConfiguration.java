...
import org.thingsboard.rule.engine.math.mapper.ParentEntitiesQuery;
import org.thingsboard.rule.engine.math.mapper.ParentEntitiesRelationsQuery;
import org.thingsboard.rule.engine.math.mapper.TbAbstractMapperNodeConfiguration;
...
@Data
public class TbAggLatestNodeConfiguration extends TbAbstractMapperNodeConfiguration implements NodeConfiguration {

    private List<AggLatestMapping> aggMappings;

    @Override
    public TbAggLatestNodeConfiguration defaultConfiguration() {
        TbAggLatestNodeConfiguration configuration = new TbAggLatestNodeConfiguration();
        ParentEntitiesRelationsQuery parentEntitiesQuery = new ParentEntitiesRelationsQuery();
        ...
        parentEntitiesQuery.setRelationsQuery(relationsQuery);
        parentEntitiesQuery.setChildRelationsQuery(relationsQuery);

        configuration.setParentEntitiesQuery(parentEntitiesQuery);
