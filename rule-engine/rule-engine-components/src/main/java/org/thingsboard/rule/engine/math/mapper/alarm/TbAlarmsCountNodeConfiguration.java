...
@Data
public class TbAlarmsCountNodeConfiguration extends TbAbstractMapperNodeConfiguration implements NodeConfiguration {

    private boolean calculateForChildEntities;
    ...
    public TbAlarmsCountNodeConfiguration defaultConfiguration() {
        ...
        configuration.setCalculateForChildEntities(false);
