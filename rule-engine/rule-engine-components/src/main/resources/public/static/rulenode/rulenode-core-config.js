...
import { Component, Pipe, ViewChild, forwardRef, Input, NgModule, Inject } from '@angular/core';
import * as i3$5 from '@shared/public-api';
import { RuleNodeConfigurationComponent, AttributeScope, telemetryTypeTranslations, EntitySearchDirection, CONTAINS_TYPE, ServiceType, AlarmSeverity, alarmSeverityTranslations, entitySearchDirectionTranslations, EntityType, PageComponent, MessageType, messageTypeNames, SharedModule, AggregationType, aggregationTranslations, alarmStatusTranslations, AlarmStatus, entityGroupTypes, DialogComponent, LatestTelemetry, DAY } from '@shared/public-api';
...
import * as i7$1 from '@shared/components/button/toggle-password.component';
import * as i8 from '@shared/components/file-input.component';
import * as i3$2 from '@shared/components/queue/queue-type-list.component';
import * as i3$3 from '@core/public-api';
import { isDefinedAndNotNull, deepClone } from '@core/public-api';
...
import * as i7$2 from '@shared/components/entity/entity-type-select.component';
import * as i8$1 from '@shared/components/entity/entity-select.component';
...
import * as i7$3 from '@shared/components/tb-checkbox.component';
import * as i5$3 from '@home/components/sms/sms-provider-configuration.component';
import * as i5$4 from '@home/components/scheduler/config/report-config.component';
import * as i3$4 from '@shared/components/entity/entity-autocomplete.component';
import { HomeComponentsModule } from '@home/components/public-api';
import * as i7$4 from '@shared/components/relation/relation-type-autocomplete.component';
import * as i8$2 from '@shared/components/entity/entity-subtype-list.component';
import * as i7$5 from '@home/components/relation/relation-filters.component';
import { of } from 'rxjs';
import * as i7$6 from '@angular/material/autocomplete';
import * as i12$1 from '@shared/pipe/highlight.pipe';
import * as i3$6 from '@shared/components/entity/entity-type-list.component';
import * as i10$1 from '@shared/components/group/entity-group-select.component';
import * as i7$7 from '@shared/components/time/timezone-select.component';
import * as i7$8 from '@angular/material/radio';
import * as i3$7 from '@angular/material/dialog';
import { MAT_DIALOG_DATA } from '@angular/material/dialog';
import * as i2$1 from '@angular/router';
import * as i6$2 from '@angular/material/toolbar';
import * as i9$2 from '@angular/material/progress-bar';
import * as i15 from '@shared/components/time/timeinterval.component';
...
var OwnerType;
(function (OwnerType) {
    OwnerType["TENANT"] = "TENANT";
    OwnerType["CUSTOMER"] = "CUSTOMER";
})(OwnerType || (OwnerType = {}));
const ownerTypeTranslations = new Map([
...
(function (MathFunction) {
    ...
    MathFunction["COUNT_UNIQUE"] = "COUNT_UNIQUE";
})(MathFunction || (MathFunction = {}));
const mathFunctionTranslations = new Map([
    [MathFunction.MIN, 'tb.rulenode.func-min'],
    [MathFunction.MAX, 'tb.rulenode.func-max'],
    [MathFunction.SUM, 'tb.rulenode.func-sum'],
    [MathFunction.AVG, 'tb.rulenode.func-avg'],
    [MathFunction.COUNT, 'tb.rulenode.func-count'],
    [MathFunction.COUNT_UNIQUE, 'tb.rulenode.func-count-unique']
]);
var AggIntervalType;
(function (AggIntervalType) {
    AggIntervalType["HOUR"] = "HOUR";
    AggIntervalType["DAY"] = "DAY";
    AggIntervalType["WEEK"] = "WEEK";
    AggIntervalType["WEEK_SUN_SAT"] = "WEEK_SUN_SAT";
    AggIntervalType["MONTH"] = "MONTH";
    AggIntervalType["YEAR"] = "YEAR";
    AggIntervalType["CUSTOM"] = "CUSTOM";
})(AggIntervalType || (AggIntervalType = {}));
const aggIntervalTypeTranslations = new Map([
...
var IntervalPersistPolicy;
(function (IntervalPersistPolicy) {
    IntervalPersistPolicy["ON_EACH_CHECK"] = "ON_EACH_CHECK";
    IntervalPersistPolicy["ON_EACH_CHECK_AFTER_INTERVAL_END"] = "ON_EACH_CHECK_AFTER_INTERVAL_END";
    IntervalPersistPolicy["ON_EACH_MESSAGE"] = "ON_EACH_MESSAGE";
})(IntervalPersistPolicy || (IntervalPersistPolicy = {}));
const intervalPersistPolicyTranslations = new Map([
...
var StatePersistPolicy;
(function (StatePersistPolicy) {
    StatePersistPolicy["ON_EACH_CHANGE"] = "ON_EACH_CHANGE";
    StatePersistPolicy["PERIODICALLY"] = "PERIODICALLY";
})(StatePersistPolicy || (StatePersistPolicy = {}));
const statePersistPolicyTranslations = new Map([
...
function prepareParentEntitiesQuery(parentEntitiesQuery) {
    if (parentEntitiesQuery && parentEntitiesQuery.type) {
        const parentEntitiesQueryType = parentEntitiesQuery.type;
...
CheckPointConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: CheckPointConfigComponent, selector: "tb-action-node-check-point-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"checkPointConfigForm\" fxLayout=\"column\">\n  <tb-queue-type-list\n    required\n    [queueType]=\"serviceType\"\n    formControlName=\"queueName\">\n  </tb-queue-type-list>\n</section>\n", components: [{ type: i3$2.QueueTypeListComponent, selector: "tb-queue-type-list", inputs: ["required", "disabled", "queueType"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }] });
...
DeleteRelationConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: DeleteRelationConfigComponent, selector: "tb-action-node-delete-relation-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"deleteRelationConfigForm\" fxLayout=\"column\">\n  <mat-checkbox formControlName=\"deleteForSingleEntity\">\n    {{ 'tb.rulenode.delete-relation-to-specific-entity' | translate }}\n  </mat-checkbox>\n  <div class=\"tb-hint\" style=\"padding-bottom: 16px;\" translate>tb.rulenode.delete-relation-hint</div>\n  <mat-form-field class=\"mat-block\" style=\"min-width: 100px;\">\n    <mat-label translate>relation.direction</mat-label>\n    <mat-select required matInput formControlName=\"direction\">\n      <mat-option *ngFor=\"let type of directionTypes\" [value]=\"type\">\n        {{ directionTypeTranslations.get(type) | translate }}\n      </mat-option>\n    </mat-select>\n  </mat-form-field>\n  <div *ngIf=\"deleteRelationConfigForm.get('deleteForSingleEntity').value\" fxLayout=\"row\" fxLayoutGap=\"8px\">\n    <tb-entity-type-select\n      showLabel\n      style=\"min-width: 100px;\"\n      required\n      formControlName=\"entityType\">\n    </tb-entity-type-select>\n    <mat-form-field *ngIf=\"deleteRelationConfigForm.get('entityType').value\" fxFlex class=\"mat-block\" style=\"padding-bottom: 32px;\">\n      <mat-label translate>tb.rulenode.entity-name-pattern</mat-label>\n      <input required matInput formControlName=\"entityNamePattern\">\n      <mat-error *ngIf=\"deleteRelationConfigForm.get('entityNamePattern').hasError('required') ||\n                        deleteRelationConfigForm.get('entityNamePattern').hasError('pattern')\">\n        {{ 'tb.rulenode.entity-name-pattern-required' | translate }}\n      </mat-error>\n      <mat-hint [innerHTML]=\"'tb.rulenode.general-pattern-hint' | translate | safeHtml\"></mat-hint>\n    </mat-form-field>\n  </div>\n  <mat-form-field class=\"mat-block\" style=\"padding-bottom: 16px;\">\n    <mat-label translate>tb.rulenode.relation-type-pattern</mat-label>\n    <input required matInput formControlName=\"relationType\">\n    <mat-error *ngIf=\"deleteRelationConfigForm.get('relationType').hasError('required')\">\n      {{ 'tb.rulenode.relation-type-pattern-required' | translate }}\n    </mat-error>\n    <mat-hint [innerHTML]=\"'tb.rulenode.general-pattern-hint' | translate | safeHtml\"></mat-hint>\n  </mat-form-field>\n  <mat-form-field class=\"mat-block\" style=\"padding-bottom: 16px;\">\n    <mat-label translate>tb.rulenode.entity-cache-expiration</mat-label>\n    <input required type=\"number\" min=\"0\" step=\"1\" matInput formControlName=\"entityCacheExpiration\">\n    <mat-error *ngIf=\"deleteRelationConfigForm.get('entityCacheExpiration').hasError('required')\">\n      {{ 'tb.rulenode.entity-cache-expiration-required' | translate }}\n    </mat-error>\n    <mat-error *ngIf=\"deleteRelationConfigForm.get('entityCacheExpiration').hasError('min')\">\n      {{ 'tb.rulenode.entity-cache-expiration-range' | translate }}\n    </mat-error>\n    <mat-hint translate>tb.rulenode.entity-cache-expiration-hint</mat-hint>\n  </mat-form-field>\n</section>\n", components: [{ type: i3$1.MatCheckbox, selector: "mat-checkbox", inputs: ["disableRipple", "color", "tabIndex", "aria-label", "aria-labelledby", "id", "labelPosition", "name", "required", "checked", "disabled", "indeterminate", "aria-describedby", "value"], outputs: ["change", "indeterminateChange"], exportAs: ["matCheckbox"] }, { type: i3.MatFormField, selector: "mat-form-field", inputs: ["color", "floatLabel", "appearance", "hideRequiredMarker", "hintLabel"], exportAs: ["matFormField"] }, { type: i4$1.MatSelect, selector: "mat-select", inputs: ["disabled", "disableRipple", "tabIndex"], exportAs: ["matSelect"] }, { type: i5.MatOption, selector: "mat-option", exportAs: ["matOption"] }, { type: i7$2.EntityTypeSelectComponent, selector: "tb-entity-type-select", inputs: ["allowedEntityTypes", "useAliasEntityTypes", "operation", "showLabel", "required", "disabled"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i3.MatLabel, selector: "mat-label" }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i10.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { type: i10.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i7.DefaultLayoutGapDirective, selector: "  [fxLayoutGap], [fxLayoutGap.xs], [fxLayoutGap.sm], [fxLayoutGap.md],  [fxLayoutGap.lg], [fxLayoutGap.xl], [fxLayoutGap.lt-sm], [fxLayoutGap.lt-md],  [fxLayoutGap.lt-lg], [fxLayoutGap.lt-xl], [fxLayoutGap.gt-xs], [fxLayoutGap.gt-sm],  [fxLayoutGap.gt-md], [fxLayoutGap.gt-lg]", inputs: ["fxLayoutGap", "fxLayoutGap.xs", "fxLayoutGap.sm", "fxLayoutGap.md", "fxLayoutGap.lg", "fxLayoutGap.xl", "fxLayoutGap.lt-sm", "fxLayoutGap.lt-md", "fxLayoutGap.lt-lg", "fxLayoutGap.lt-xl", "fxLayoutGap.gt-xs", "fxLayoutGap.gt-sm", "fxLayoutGap.gt-md", "fxLayoutGap.gt-lg"] }, { type: i7.DefaultFlexDirective, selector: "  [fxFlex], [fxFlex.xs], [fxFlex.sm], [fxFlex.md],  [fxFlex.lg], [fxFlex.xl], [fxFlex.lt-sm], [fxFlex.lt-md],  [fxFlex.lt-lg], [fxFlex.lt-xl], [fxFlex.gt-xs], [fxFlex.gt-sm],  [fxFlex.gt-md], [fxFlex.gt-lg]", inputs: ["fxFlex", "fxFlex.xs", "fxFlex.sm", "fxFlex.md", "fxFlex.lg", "fxFlex.xl", "fxFlex.lt-sm", "fxFlex.lt-md", "fxFlex.lt-lg", "fxFlex.lt-xl", "fxFlex.gt-xs", "fxFlex.gt-sm", "fxFlex.gt-md", "fxFlex.gt-lg"] }, { type: i11.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["id", "disabled", "required", "type", "value", "readonly", "placeholder", "errorStateMatcher", "aria-describedby"], exportAs: ["matInput"] }, { type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i3.MatError, selector: "mat-error", inputs: ["id"] }, { type: i3.MatHint, selector: "mat-hint", inputs: ["align", "id"] }, { type: i2.MinValidator, selector: "input[type=number][min][formControlName],input[type=number][min][formControl],input[type=number][min][ngModel]", inputs: ["min"] }, { type: i2.NumberValueAccessor, selector: "input[type=number][formControlName],input[type=number][formControl],input[type=number][ngModel]" }], pipes: { "translate": i4.TranslatePipe, "safeHtml": SafeHtmlPipe } });
...
LogConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: LogConfigComponent, selector: "tb-action-node-log-config", viewQueries: [{ propertyName: "jsFuncComponent", first: true, predicate: ["jsFuncComponent"], descendants: true, static: true }], usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"logConfigForm\" fxLayout=\"column\">\n  <label translate class=\"tb-title no-padding\">tb.rulenode.to-string</label>\n  <tb-js-func #jsFuncComponent\n              formControlName=\"jsScript\"\n              functionName=\"ToString\"\n              [functionArgs]=\"['msg', 'metadata', 'msgType']\"\n              helpId=\"rulenode/log_node_script_fn\"\n              noValidate=\"true\">\n  </tb-js-func>\n  <div fxLayout=\"row\">\n    <button mat-button mat-raised-button color=\"primary\" (click)=\"testScript()\">\n      {{ 'tb.rulenode.test-to-string-function' | translate }}\n    </button>\n  </div>\n</section>\n", components: [{ type: i5$1.JsFuncComponent, selector: "tb-js-func", inputs: ["functionName", "functionArgs", "validationArgs", "resultType", "disabled", "fillHeight", "editorCompleter", "globalVariables", "disableUndefinedCheck", "helpId", "noValidate", "required"] }, { type: i6.MatButton, selector: "button[mat-button], button[mat-raised-button], button[mat-icon-button],             button[mat-fab], button[mat-mini-fab], button[mat-stroked-button],             button[mat-flat-button]", inputs: ["disabled", "disableRipple", "color"], exportAs: ["matButton"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }], pipes: { "translate": i4.TranslatePipe } });
...
class AddToGroupConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
...
class ChangeOwnerConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
        this.ownerType = OwnerType;
        this.ownerTypes = Object.keys(OwnerType);
        this.ownerTypeTranslationsMap = ownerTypeTranslations;
    }
    configForm() {
    ...
    onConfigurationSet(configuration) {
        this.changeOwnerConfigForm = this.fb.group({
            ...
            ownerCacheExpiration: [configuration ? configuration.ownerCacheExpiration : null, []]
        });
    }
    validatorTriggers() {
        return ['ownerType'];
    ...
    updateValidators(emitEvent) {
        const ownerType = this.changeOwnerConfigForm.get('ownerType').value;
        if (ownerType === OwnerType.CUSTOMER) {
            ...
            this.changeOwnerConfigForm.get('ownerCacheExpiration').setValidators([Validators.required, Validators.min(0)]);
        }
        else {
            this.changeOwnerConfigForm.get('ownerNamePattern').setValidators([]);
            this.changeOwnerConfigForm.get('ownerCacheExpiration').setValidators([]);
        }
        this.changeOwnerConfigForm.get('ownerNamePattern').updateValueAndValidity({ emitEvent });
        this.changeOwnerConfigForm.get('ownerCacheExpiration').updateValueAndValidity({ emitEvent });
    }
    prepareOutputConfig(configuration) {
...
class GenerateReportConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
    ...
    updateValidators(emitEvent) {
        const useSystemReportsServer = this.generateReportConfigForm.get('useSystemReportsServer').value;
        const useReportConfigFromMessage = this.generateReportConfigForm.get('useReportConfigFromMessage').value;
        if (emitEvent) {
            const reportsServerEndpointUrl = this.generateReportConfigForm.get('reportsServerEndpointUrl').value;
            if (useSystemReportsServer) {
                ...
                if (!reportsServerEndpointUrl || !reportsServerEndpointUrl.length) {
                    this.generateReportConfigForm.get('reportsServerEndpointUrl').reset('http://localhost:8383', { emitEvent: false });
                }
            }
        }
        if (useSystemReportsServer) {
...
GenerateReportConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: GenerateReportConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
GenerateReportConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: GenerateReportConfigComponent, selector: "tb-action-node-generate-report-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"generateReportConfigForm\" fxLayout=\"column\">\n  <mat-checkbox fxFlex formControlName=\"useSystemReportsServer\" style=\"padding-bottom: 16px;\">\n    {{ 'tb.rulenode.use-system-reports-server' | translate }}\n  </mat-checkbox>\n  <mat-form-field class=\"mat-block\" *ngIf=\"!generateReportConfigForm.get('useSystemReportsServer').value\">\n    <mat-label translate>tb.rulenode.reports-server-endpoint-url</mat-label>\n    <input required matInput formControlName=\"reportsServerEndpointUrl\">\n    <mat-error *ngIf=\"generateReportConfigForm.get('reportsServerEndpointUrl').hasError('required')\">\n      {{ 'tb.rulenode.reports-server-endpoint-url-is-required' | translate }}\n    </mat-error>\n  </mat-form-field>\n  <mat-checkbox fxFlex formControlName=\"useReportConfigFromMessage\" style=\"padding-bottom: 16px;\">\n    {{ 'tb.rulenode.use-report-config-from-message' | translate }}\n  </mat-checkbox>\n  <tb-report-config\n    *ngIf=\"!generateReportConfigForm.get('useReportConfigFromMessage').value\"\n    formControlName=\"reportConfig\"\n    [reportsServerEndpointUrl]=\"generateReportConfigForm.get('reportsServerEndpointUrl').value\">\n  </tb-report-config>\n</section>\n", components: [{ type: i3$1.MatCheckbox, selector: "mat-checkbox", inputs: ["disableRipple", "color", "tabIndex", "aria-label", "aria-labelledby", "id", "labelPosition", "name", "required", "checked", "disabled", "indeterminate", "aria-describedby", "value"], outputs: ["change", "indeterminateChange"], exportAs: ["matCheckbox"] }, { type: i3.MatFormField, selector: "mat-form-field", inputs: ["color", "floatLabel", "appearance", "hideRequiredMarker", "hintLabel"], exportAs: ["matFormField"] }, { type: i5$4.ReportConfigComponent, selector: "tb-report-config", inputs: ["reportsServerEndpointUrl", "disabled"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i7.DefaultFlexDirective, selector: "  [fxFlex], [fxFlex.xs], [fxFlex.sm], [fxFlex.md],  [fxFlex.lg], [fxFlex.xl], [fxFlex.lt-sm], [fxFlex.lt-md],  [fxFlex.lt-lg], [fxFlex.lt-xl], [fxFlex.gt-xs], [fxFlex.gt-sm],  [fxFlex.gt-md], [fxFlex.gt-lg]", inputs: ["fxFlex", "fxFlex.xs", "fxFlex.sm", "fxFlex.md", "fxFlex.lg", "fxFlex.xl", "fxFlex.lt-sm", "fxFlex.lt-md", "fxFlex.lt-lg", "fxFlex.lt-xl", "fxFlex.gt-xs", "fxFlex.gt-sm", "fxFlex.gt-md", "fxFlex.gt-lg"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i10.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i3.MatLabel, selector: "mat-label" }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i11.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["id", "disabled", "required", "type", "value", "readonly", "placeholder", "errorStateMatcher", "aria-describedby"], exportAs: ["matInput"] }, { type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i3.MatError, selector: "mat-error", inputs: ["id"] }], pipes: { "translate": i4.TranslatePipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: GenerateReportConfigComponent, decorators: [{
            type: Component,
            args: [{
...
class IntegrationDownlinkConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
...
IntegrationDownlinkConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: IntegrationDownlinkConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
IntegrationDownlinkConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: IntegrationDownlinkConfigComponent, selector: "tb-action-node-integration-downlink-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"integrationDownlinkConfigForm\" fxLayout=\"column\">\n  <tb-entity-autocomplete\n    required\n    [entityType]=\"entityType.INTEGRATION\"\n    formControlName=\"integrationId\">\n  </tb-entity-autocomplete>\n</section>\n", components: [{ type: i3$4.EntityAutocompleteComponent, selector: "tb-entity-autocomplete", inputs: ["entityType", "entitySubtype", "excludeEntityIds", "labelText", "requiredText", "useFullEntityId", "required", "disabled"], outputs: ["entityChanged"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: IntegrationDownlinkConfigComponent, decorators: [{
            type: Component,
            args: [{
...
class RemoveFromGroupConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
...
RemoveFromGroupConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: RemoveFromGroupConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
RemoveFromGroupConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: RemoveFromGroupConfigComponent, selector: "tb-action-node-remove-from-group-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"removeFromGroupConfigForm\" fxLayout=\"column\">\n  <mat-form-field class=\"mat-block\" style=\"padding-bottom: 16px;\">\n    <mat-label translate>tb.rulenode.group-name-pattern</mat-label>\n    <input required matInput formControlName=\"groupNamePattern\">\n    <mat-error *ngIf=\"removeFromGroupConfigForm.get('groupNamePattern').hasError('required') ||\n                      removeFromGroupConfigForm.get('groupNamePattern').hasError('pattern')\">\n      {{ 'tb.rulenode.group-name-pattern-required' | translate }}\n    </mat-error>\n    <mat-hint [innerHTML]=\"'tb.rulenode.general-pattern-hint' | translate | safeHtml\"></mat-hint>\n  </mat-form-field>\n  <mat-form-field class=\"mat-block\" style=\"padding-bottom: 16px;\">\n    <mat-label translate>tb.rulenode.group-cache-expiration</mat-label>\n    <input required type=\"number\" min=\"0\" step=\"1\" matInput formControlName=\"groupCacheExpiration\">\n    <mat-error *ngIf=\"removeFromGroupConfigForm.get('groupCacheExpiration').hasError('required')\">\n      {{ 'tb.rulenode.group-cache-expiration-required' | translate }}\n    </mat-error>\n    <mat-error *ngIf=\"removeFromGroupConfigForm.get('groupCacheExpiration').hasError('min')\">\n      {{ 'tb.rulenode.group-cache-expiration-range' | translate }}\n    </mat-error>\n    <mat-hint innerHTML=\"{{ 'tb.rulenode.group-cache-expiration-hint' | translate }}\"></mat-hint>\n  </mat-form-field>\n</section>\n", components: [{ type: i3.MatFormField, selector: "mat-form-field", inputs: ["color", "floatLabel", "appearance", "hideRequiredMarker", "hintLabel"], exportAs: ["matFormField"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i3.MatLabel, selector: "mat-label" }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i11.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["id", "disabled", "required", "type", "value", "readonly", "placeholder", "errorStateMatcher", "aria-describedby"], exportAs: ["matInput"] }, { type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i10.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i3.MatError, selector: "mat-error", inputs: ["id"] }, { type: i3.MatHint, selector: "mat-hint", inputs: ["align", "id"] }, { type: i2.MinValidator, selector: "input[type=number][min][formControlName],input[type=number][min][formControl],input[type=number][min][ngModel]", inputs: ["min"] }, { type: i2.NumberValueAccessor, selector: "input[type=number][formControlName],input[type=number][formControl],input[type=number][ngModel]" }], pipes: { "translate": i4.TranslatePipe, "safeHtml": SafeHtmlPipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: RemoveFromGroupConfigComponent, decorators: [{
            type: Component,
            args: [{
...
class SendRestApiCallReplyConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
...
SendRestApiCallReplyConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: SendRestApiCallReplyConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
SendRestApiCallReplyConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: SendRestApiCallReplyConfigComponent, selector: "tb-action-node-send-rest-api-call-reply-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"sendRestApiCallReplyConfigForm\" fxLayout=\"column\">\n  <mat-form-field class=\"mat-block\">\n    <mat-label translate>tb.rulenode.request-id-metadata-attribute</mat-label>\n    <input matInput formControlName=\"requestIdMetaDataAttribute\">\n  </mat-form-field>\n</section>\n", components: [{ type: i3.MatFormField, selector: "mat-form-field", inputs: ["color", "floatLabel", "appearance", "hideRequiredMarker", "hintLabel"], exportAs: ["matFormField"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i3.MatLabel, selector: "mat-label" }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i11.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["id", "disabled", "required", "type", "value", "readonly", "placeholder", "errorStateMatcher", "aria-describedby"], exportAs: ["matInput"] }, { type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: SendRestApiCallReplyConfigComponent, decorators: [{
            type: Component,
            args: [{
...
MessageTypesConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: MessageTypesConfigComponent, deps: [{ token: i1.Store }, { token: i4.TranslateService }, { token: i3$5.TruncatePipe }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: MessageTypesConfigComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.Store }, { type: i4.TranslateService }, { type: i3$5.TruncatePipe }, { type: i2.FormBuilder }]; }, propDecorators: { required: [{
                type: Input
            }], label: [{
                type: Input
            }], placeholder: [{
...
class DuplicateToGroupConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
    ...
    updateValidators(emitEvent) {
        const entityGroupIsMessageOriginator = this.duplicateToGroupConfigForm.get('entityGroupIsMessageOriginator').value;
        const entityGroupId = this.duplicateToGroupConfigForm.get('entityGroupId').value;
        if (emitEvent) {
...
DuplicateToGroupConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: DuplicateToGroupConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
DuplicateToGroupConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: DuplicateToGroupConfigComponent, selector: "tb-transformation-node-duplicate-to-group-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"duplicateToGroupConfigForm\" fxLayout=\"column\">\n  <mat-checkbox fxFlex formControlName=\"entityGroupIsMessageOriginator\" style=\"padding-bottom: 16px;\">\n    {{ 'tb.rulenode.entity-group-is-message-originator' | translate }}\n  </mat-checkbox>\n  <section fxLayout=\"column\" *ngIf=\"!duplicateToGroupConfigForm.get('entityGroupIsMessageOriginator').value\">\n    <label translate class=\"tb-title tb-required\">tb.rulenode.target-entity-group</label>\n    <tb-entity-group-select\n      fxFlex\n      formControlName=\"entityGroupId\"\n      required\n      placeholderText=\"entity-group.select-entity-group\"\n      notFoundText=\"entity-group.no-entity-groups-matching\"\n      requiredText=\"entity-group.target-entity-group-required\">\n    </tb-entity-group-select>\n  </section>\n</section>\n", components: [{ type: i3$1.MatCheckbox, selector: "mat-checkbox", inputs: ["disableRipple", "color", "tabIndex", "aria-label", "aria-labelledby", "id", "labelPosition", "name", "required", "checked", "disabled", "indeterminate", "aria-describedby", "value"], outputs: ["change", "indeterminateChange"], exportAs: ["matCheckbox"] }, { type: i10$1.EntityGroupSelectComponent, selector: "tb-entity-group-select", inputs: ["allowedGroupTypes", "excludeGroupTypes", "defaultGroupType", "excludeGroupIds", "excludeGroupAll", "placeholderText", "notFoundText", "requiredText", "ownerId", "required", "disabled"], outputs: ["currentGroupType", "currentGroupInfo"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i7.DefaultFlexDirective, selector: "  [fxFlex], [fxFlex.xs], [fxFlex.sm], [fxFlex.md],  [fxFlex.lg], [fxFlex.xl], [fxFlex.lt-sm], [fxFlex.lt-md],  [fxFlex.lt-lg], [fxFlex.lt-xl], [fxFlex.gt-xs], [fxFlex.gt-sm],  [fxFlex.gt-md], [fxFlex.gt-lg]", inputs: ["fxFlex", "fxFlex.xs", "fxFlex.sm", "fxFlex.md", "fxFlex.lg", "fxFlex.xl", "fxFlex.lt-sm", "fxFlex.lt-md", "fxFlex.lt-lg", "fxFlex.lt-xl", "fxFlex.gt-xs", "fxFlex.gt-sm", "fxFlex.gt-md", "fxFlex.gt-lg"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i10.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }], pipes: { "translate": i4.TranslatePipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: DuplicateToGroupConfigComponent, decorators: [{
            type: Component,
            args: [{
...
class DuplicateToGroupByNameConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
        this.entityGroupTypesList = entityGroupTypes;
    }
    configForm() {
...
DuplicateToGroupByNameConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: DuplicateToGroupByNameConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
DuplicateToGroupByNameConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: DuplicateToGroupByNameConfigComponent, selector: "tb-transformation-node-duplicate-to-group-by-name-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"duplicateToGroupByNameConfigForm\" fxLayout=\"column\">\n  <mat-checkbox fxFlex formControlName=\"searchEntityGroupForTenantOnly\" style=\"padding-bottom: 16px;\">\n    {{ 'tb.rulenode.search-entity-group-for-tenant-only' | translate }}\n  </mat-checkbox>\n  <div fxFlex fxLayout=\"row\">\n    <tb-entity-type-select\n      style=\"min-width: 100px; padding-right: 8px;\"\n      required\n      showLabel\n      [allowedEntityTypes]=\"entityGroupTypesList\"\n      formControlName=\"groupType\">\n    </tb-entity-type-select>\n    <mat-form-field fxFlex class=\"mat-block\">\n      <mat-label translate>entity-group.entity-group-name</mat-label>\n      <input matInput formControlName=\"groupName\" required>\n      <mat-error *ngIf=\"duplicateToGroupByNameConfigForm.get('groupName').hasError('required')\">\n        {{ 'entity-group.name-required' | translate }}\n      </mat-error>\n    </mat-form-field>\n  </div>\n</section>\n", components: [{ type: i3$1.MatCheckbox, selector: "mat-checkbox", inputs: ["disableRipple", "color", "tabIndex", "aria-label", "aria-labelledby", "id", "labelPosition", "name", "required", "checked", "disabled", "indeterminate", "aria-describedby", "value"], outputs: ["change", "indeterminateChange"], exportAs: ["matCheckbox"] }, { type: i7$2.EntityTypeSelectComponent, selector: "tb-entity-type-select", inputs: ["allowedEntityTypes", "useAliasEntityTypes", "operation", "showLabel", "required", "disabled"] }, { type: i3.MatFormField, selector: "mat-form-field", inputs: ["color", "floatLabel", "appearance", "hideRequiredMarker", "hintLabel"], exportAs: ["matFormField"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i7.DefaultFlexDirective, selector: "  [fxFlex], [fxFlex.xs], [fxFlex.sm], [fxFlex.md],  [fxFlex.lg], [fxFlex.xl], [fxFlex.lt-sm], [fxFlex.lt-md],  [fxFlex.lt-lg], [fxFlex.lt-xl], [fxFlex.gt-xs], [fxFlex.gt-sm],  [fxFlex.gt-md], [fxFlex.gt-lg]", inputs: ["fxFlex", "fxFlex.xs", "fxFlex.sm", "fxFlex.md", "fxFlex.lg", "fxFlex.xl", "fxFlex.lt-sm", "fxFlex.lt-md", "fxFlex.lt-lg", "fxFlex.lt-xl", "fxFlex.gt-xs", "fxFlex.gt-sm", "fxFlex.gt-md", "fxFlex.gt-lg"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i3.MatLabel, selector: "mat-label" }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i11.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["id", "disabled", "required", "type", "value", "readonly", "placeholder", "errorStateMatcher", "aria-describedby"], exportAs: ["matInput"] }, { type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i10.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i3.MatError, selector: "mat-error", inputs: ["id"] }], pipes: { "translate": i4.TranslatePipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: DuplicateToGroupByNameConfigComponent, decorators: [{
            type: Component,
            args: [{
...
class DuplicateToRelatedConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
...
DuplicateToRelatedConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: DuplicateToRelatedConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
DuplicateToRelatedConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: DuplicateToRelatedConfigComponent, selector: "tb-transformation-node-duplicate-to-related-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"duplicateToRelatedConfigForm\" fxLayout=\"column\">\n  <label translate class=\"tb-title tb-required\">tb.rulenode.relations-query</label>\n  <tb-relations-query-config\n    style=\"padding-bottom: 15px;\"\n    formControlName=\"relationsQuery\">\n  </tb-relations-query-config>\n</section>\n", components: [{ type: RelationsQueryConfigComponent, selector: "tb-relations-query-config", inputs: ["disabled", "required"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: DuplicateToRelatedConfigComponent, decorators: [{
            type: Component,
            args: [{
...
RulenodeCoreConfigTransformModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: RulenodeCoreConfigTransformModule, declarations: [ChangeOriginatorConfigComponent,
        ...
        DuplicateToGroupByNameConfigComponent], imports: [CommonModule,
        SharedModule,
...
const intervalValidators$2 = [Validators.required,
    Validators.min(1), Validators.max(2147483647)];
class AggregateIncomingConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
        this.aggPeriodTimeUnits = [TimeUnit.MINUTES, TimeUnit.HOURS, TimeUnit.DAYS];
        this.timeUnitsTranslationMap = timeUnitTranslations;
        this.mathFunctions = Object.keys(MathFunction);
        this.mathFunctionsTranslationMap = mathFunctionTranslations;
        this.aggIntervalType = AggIntervalType;
        this.aggIntervalTypes = Object.keys(AggIntervalType);
        this.aggIntervalTypesTranslationMap = aggIntervalTypeTranslations;
        this.intervalPersistPolicies = Object.keys(IntervalPersistPolicy);
        this.intervalPersistPolicyTranslationMap = intervalPersistPolicyTranslations;
        this.statePersistPolicies = Object.keys(StatePersistPolicy);
        this.statePersistPolicyTranslationMap = statePersistPolicyTranslations;
        this.StatePersistPolicy = StatePersistPolicy;
    }
    configForm() {
    ...
    onConfigurationSet(configuration) {
        this.aggregateIncomingConfigForm = this.fb.group({
            ...
            intervalCheckValue: [configuration ? configuration.intervalCheckValue : null, intervalValidators$2],
            ...
            statePersistenceValue: [configuration ? configuration.statePersistenceValue : null, intervalValidators$2],
    ...
    updateValidators(emitEvent, trigger) {
        const parentEntitiesQueryControl = this.aggregateIncomingConfigForm.get('parentEntitiesQuery');
        const parentEntitiesQueryType = parentEntitiesQueryControl.get('type').value;
        if (emitEvent) {
        ...
        const aggIntervalType = this.aggregateIncomingConfigForm.get('aggIntervalType').value;
        if (aggIntervalType === AggIntervalType.CUSTOM) {
            this.aggregateIncomingConfigForm.get('timeZoneId').setValidators([]);
            this.aggregateIncomingConfigForm.get('aggIntervalValue').setValidators(intervalValidators$2);
        ...
        const autoCreateIntervals = this.aggregateIncomingConfigForm.get('autoCreateIntervals').value;
        ...
        if (autoCreateIntervals) {
            this.aggregateIncomingConfigForm.get('periodValue').setValidators(intervalValidators$2);
...
class AggregateLatestMappingDialogComponent extends DialogComponent {
    constructor(store, router, data, dialogRef, fb, translate) {
        ...
        this.attributeScopes = Object.keys(AttributeScope);
        this.telemetryTypeTranslationMap = telemetryTypeTranslations;
        this.mathFunctions = Object.keys(MathFunction);
        this.mathFunctionsTranslationMap = mathFunctionTranslations;
        this.separatorKeysCodes = [ENTER, COMMA, SEMICOLON];
    ...
    removeKey(key, keysField) {
        const keys = this.aggLatestMappingFormGroup.get('filter').get(keysField).value;
        const index = keys.indexOf(key);
        if (index >= 0) {
            keys.splice(index, 1);
    ...
    addKey(event, keysField) {
        ...
        if ((value || '').trim()) {
            value = value.trim();
            let keys = this.aggLatestMappingFormGroup.get('filter').get(keysField).value;
            if (!keys || keys.indexOf(value) === -1) {
                if (!keys) {
                    keys = [];
                }
...
AggregateLatestMappingDialogComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AggregateLatestMappingDialogComponent, deps: [{ token: i1.Store }, { token: i2$1.Router }, { token: MAT_DIALOG_DATA }, { token: i3$7.MatDialogRef }, { token: i2.FormBuilder }, { token: i4.TranslateService }], target: i0.ɵɵFactoryTarget.Component });
AggregateLatestMappingDialogComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: AggregateLatestMappingDialogComponent, selector: "tb-agg-latest-mapping-dialog", usesInheritance: true, ngImport: i0, template: "<!--\n\n    ThingsBoard, Inc. (\"COMPANY\") CONFIDENTIAL\n\n    Copyright \u00A9 2016-2020 ThingsBoard, Inc. All Rights Reserved.\n\n    NOTICE: All information contained herein is, and remains\n    the property of ThingsBoard, Inc. and its suppliers,\n    if any.  The intellectual and technical concepts contained\n    herein are proprietary to ThingsBoard, Inc.\n    and its suppliers and may be covered by U.S. and Foreign Patents,\n    patents in process, and are protected by trade secret or copyright law.\n\n    Dissemination of this information or reproduction of this material is strictly forbidden\n    unless prior written permission is obtained from COMPANY.\n\n    Access to the source code contained herein is hereby forbidden to anyone except current COMPANY employees,\n    managers or contractors who have executed Confidentiality and Non-disclosure agreements\n    explicitly covering such access.\n\n    The copyright notice above does not evidence any actual or intended publication\n    or disclosure  of  this source code, which includes\n    information that is confidential and/or proprietary, and is a trade secret, of  COMPANY.\n    ANY REPRODUCTION, MODIFICATION, DISTRIBUTION, PUBLIC  PERFORMANCE,\n    OR PUBLIC DISPLAY OF OR THROUGH USE  OF THIS  SOURCE CODE  WITHOUT\n    THE EXPRESS WRITTEN CONSENT OF COMPANY IS STRICTLY PROHIBITED,\n    AND IN VIOLATION OF APPLICABLE LAWS AND INTERNATIONAL TREATIES.\n    THE RECEIPT OR POSSESSION OF THIS SOURCE CODE AND/OR RELATED INFORMATION\n    DOES NOT CONVEY OR IMPLY ANY RIGHTS TO REPRODUCE, DISCLOSE OR DISTRIBUTE ITS CONTENTS,\n    OR TO MANUFACTURE, USE, OR SELL ANYTHING THAT IT  MAY DESCRIBE, IN WHOLE OR IN PART.\n\n-->\n<form [formGroup]=\"aggLatestMappingFormGroup\" (ngSubmit)=\"save()\" style=\"width: 650px;\">\n  <mat-toolbar fxLayout=\"row\" color=\"primary\">\n    <h2>{{ (isAdd ? 'tb.rulenode.add-mapping' : 'tb.rulenode.edit-mapping') | translate }}</h2>\n    <span fxFlex></span>\n    <button mat-button mat-icon-button\n            (click)=\"cancel()\"\n            type=\"button\">\n      <mat-icon class=\"material-icons\">close</mat-icon>\n    </button>\n  </mat-toolbar>\n  <mat-progress-bar color=\"warn\" mode=\"indeterminate\" *ngIf=\"isLoading$ | async\">\n  </mat-progress-bar>\n  <div style=\"height: 4px;\" *ngIf=\"!(isLoading$ | async)\"></div>\n  <div mat-dialog-content>\n    <fieldset [disabled]=\"isLoading$ | async\">\n      <tb-checkbox\n        [trueValue]=\"latestTelemetry.LATEST_TELEMETRY\"\n        [falseValue]=\"attributeScope.SERVER_SCOPE\"\n        formControlName=\"sourceScope\" style=\"display: block; margin-bottom: 16px;\">\n        {{ 'tb.rulenode.latest-telemetry' | translate }}\n      </tb-checkbox>\n      <div fxLayout=\"row\" fxLayoutGap=\"8px\">\n        <mat-form-field fxFlex class=\"mat-block\">\n          <mat-label>{{(aggLatestMappingFormGroup.get('sourceScope').value ===\n                   latestTelemetry.LATEST_TELEMETRY ? 'tb.rulenode.source-telemetry'\n                            : 'tb.rulenode.source-attribute') | translate}}</mat-label>\n          <input matInput formControlName=\"source\">\n        </mat-form-field>\n        <mat-form-field class=\"mat-block\"\n                        *ngIf=\"aggLatestMappingFormGroup.get('sourceScope').value !== latestTelemetry.LATEST_TELEMETRY\"\n                        style=\"width: 200px;\">\n          <mat-label translate>tb.rulenode.attribute-scope</mat-label>\n          <mat-select formControlName=\"sourceScope\">\n            <mat-option *ngFor=\"let scope of attributeScopes\" [value]=\"scope\">\n              {{ telemetryTypeTranslationMap.get(scope) | translate }}\n            </mat-option>\n          </mat-select>\n        </mat-form-field>\n        <mat-form-field fxFlex class=\"mat-block\">\n          <mat-label translate>tb.rulenode.default-value</mat-label>\n          <input required type=\"number\" matInput formControlName=\"defaultValue\">\n          <mat-error *ngIf=\"aggLatestMappingFormGroup.get('defaultValue').hasError('required')\">\n            {{ 'tb.rulenode.default-value-required' | translate }}\n          </mat-error>\n        </mat-form-field>\n      </div>\n      <div fxLayout=\"row\" fxLayoutGap=\"8px\">\n        <mat-form-field class=\"mat-block\" style=\"width: 200px;\">\n          <mat-label translate>tb.rulenode.math-function</mat-label>\n          <mat-select formControlName=\"aggFunction\" required>\n            <mat-option *ngFor=\"let mathFunction of mathFunctions\" [value]=\"mathFunction\">\n              {{ mathFunctionsTranslationMap.get(mathFunction) | translate }}\n            </mat-option>\n          </mat-select>\n        </mat-form-field>\n        <mat-form-field fxFlex class=\"mat-block\">\n          <mat-label translate>tb.rulenode.target-telemetry</mat-label>\n          <input required matInput formControlName=\"target\">\n          <mat-error *ngIf=\"aggLatestMappingFormGroup.get('target').hasError('required')\">\n            {{ 'tb.rulenode.target-telemetry-required' | translate }}\n          </mat-error>\n        </mat-form-field>\n      </div>\n      <mat-checkbox\n        [(ngModel)]=\"filterEntities\"\n        [ngModelOptions]=\"{ standalone: true}\"\n        (ngModelChange)=\"filterEntitiesChange()\" style=\"display: block; margin-bottom: 16px;\">\n        {{ 'tb.rulenode.filter-entities' | translate }}\n      </mat-checkbox>\n      <mat-expansion-panel *ngIf=\"filterEntities\"\n        [expanded]=\"true\" formGroupName=\"filter\">\n        <mat-expansion-panel-header>\n          <mat-panel-title translate>tb.rulenode.entity-filter</mat-panel-title>\n        </mat-expansion-panel-header>\n        <section fxLayout=\"column\">\n          <label translate class=\"tb-title no-padding\" style=\"padding-bottom: 10px;\">tb.rulenode.fetch-entity-attributes</label>\n          <label translate class=\"tb-title no-padding\">tb.rulenode.client-attributes</label>\n          <mat-form-field floatLabel=\"always\" class=\"mat-block\">\n            <mat-label></mat-label>\n            <mat-chip-list #clientAttributesChipList>\n              <mat-chip\n                *ngFor=\"let key of aggLatestMappingFormGroup.get('filter').get('clientAttributeNames').value;\"\n                (removed)=\"removeKey(key, 'clientAttributeNames')\">\n                {{key}}\n                <mat-icon matChipRemove>close</mat-icon>\n              </mat-chip>\n              <input matInput type=\"text\" placeholder=\"{{'tb.rulenode.client-attributes' | translate}}\"\n                     style=\"max-width: 200px;\"\n                     [matChipInputFor]=\"clientAttributesChipList\"\n                     [matChipInputSeparatorKeyCodes]=\"separatorKeysCodes\"\n                     (matChipInputTokenEnd)=\"addKey($event, 'clientAttributeNames')\"\n                     [matChipInputAddOnBlur]=\"true\">\n            </mat-chip-list>\n          </mat-form-field>\n          <label translate class=\"tb-title no-padding\">tb.rulenode.shared-attributes</label>\n          <mat-form-field floatLabel=\"always\" class=\"mat-block\">\n            <mat-label></mat-label>\n            <mat-chip-list #sharedAttributesChipList>\n              <mat-chip\n                *ngFor=\"let key of aggLatestMappingFormGroup.get('filter').get('sharedAttributeNames').value;\"\n                (removed)=\"removeKey(key, 'sharedAttributeNames')\">\n                {{key}}\n                <mat-icon matChipRemove>close</mat-icon>\n              </mat-chip>\n              <input matInput type=\"text\" placeholder=\"{{'tb.rulenode.shared-attributes' | translate}}\"\n                     style=\"max-width: 200px;\"\n                     [matChipInputFor]=\"sharedAttributesChipList\"\n                     [matChipInputSeparatorKeyCodes]=\"separatorKeysCodes\"\n                     (matChipInputTokenEnd)=\"addKey($event, 'sharedAttributeNames')\"\n                     [matChipInputAddOnBlur]=\"true\">\n            </mat-chip-list>\n          </mat-form-field>\n          <label translate class=\"tb-title no-padding\">tb.rulenode.server-attributes</label>\n          <mat-form-field floatLabel=\"always\" class=\"mat-block\">\n            <mat-label></mat-label>\n            <mat-chip-list #serverAttributesChipList>\n              <mat-chip\n                *ngFor=\"let key of aggLatestMappingFormGroup.get('filter').get('serverAttributeNames').value;\"\n                (removed)=\"removeKey(key, 'serverAttributeNames')\">\n                {{key}}\n                <mat-icon matChipRemove>close</mat-icon>\n              </mat-chip>\n              <input matInput type=\"text\" placeholder=\"{{'tb.rulenode.server-attributes' | translate}}\"\n                     style=\"max-width: 200px;\"\n                     [matChipInputFor]=\"serverAttributesChipList\"\n                     [matChipInputSeparatorKeyCodes]=\"separatorKeysCodes\"\n                     (matChipInputTokenEnd)=\"addKey($event, 'serverAttributeNames')\"\n                     [matChipInputAddOnBlur]=\"true\">\n            </mat-chip-list>\n          </mat-form-field>\n          <label translate class=\"tb-title no-padding\">tb.rulenode.latest-timeseries</label>\n          <mat-form-field floatLabel=\"always\" class=\"mat-block\">\n            <mat-label></mat-label>\n            <mat-chip-list #latestTimeseriesChipList>\n              <mat-chip\n                *ngFor=\"let key of aggLatestMappingFormGroup.get('filter').get('latestTsKeyNames').value;\"\n                (removed)=\"removeKey(key, 'latestTsKeyNames')\">\n                {{key}}\n                <mat-icon matChipRemove>close</mat-icon>\n              </mat-chip>\n              <input matInput type=\"text\" placeholder=\"{{'tb.rulenode.latest-timeseries' | translate}}\"\n                     style=\"max-width: 200px;\"\n                     [matChipInputFor]=\"latestTimeseriesChipList\"\n                     [matChipInputSeparatorKeyCodes]=\"separatorKeysCodes\"\n                     (matChipInputTokenEnd)=\"addKey($event, 'latestTsKeyNames')\"\n                     [matChipInputAddOnBlur]=\"true\">\n            </mat-chip-list>\n          </mat-form-field>\n          <label translate class=\"tb-title no-padding\">tb.rulenode.filter</label>\n          <tb-js-func\n            formControlName=\"filterFunction\"\n            functionName=\"Filter\"\n            [functionArgs]=\"['attributes']\"\n            helpId=\"rulenode/agg_latest_entity_filter_fn\"\n            noValidate>\n          </tb-js-func>\n        </section>\n      </mat-expansion-panel>\n    </fieldset>\n  </div>\n  <div mat-dialog-actions fxLayout=\"row\" fxLayoutAlign=\"end center\">\n    <span fxFlex></span>\n    <button mat-button mat-raised-button color=\"primary\"\n            type=\"submit\"\n            [disabled]=\"(isLoading$ | async) || aggLatestMappingFormGroup.invalid || !aggLatestMappingFormGroup.dirty\">\n      {{ (isAdd ? 'action.add' : 'action.save') | translate }}\n    </button>\n    <button mat-button color=\"primary\"\n            style=\"margin-right: 20px;\"\n            type=\"button\"\n            [disabled]=\"(isLoading$ | async)\"\n            (click)=\"cancel()\" cdkFocusInitial>\n      {{ 'action.cancel' | translate }}\n    </button>\n  </div>\n</form>\n", components: [{ type: i6$2.MatToolbar, selector: "mat-toolbar", inputs: ["color"], exportAs: ["matToolbar"] }, { type: i6.MatButton, selector: "button[mat-button], button[mat-raised-button], button[mat-icon-button],             button[mat-fab], button[mat-mini-fab], button[mat-stroked-button],             button[mat-flat-button]", inputs: ["disabled", "disableRipple", "color"], exportAs: ["matButton"] }, { type: i6$1.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { type: i9$2.MatProgressBar, selector: "mat-progress-bar", inputs: ["color", "mode", "value", "bufferValue"], outputs: ["animationEnd"], exportAs: ["matProgressBar"] }, { type: i7$3.TbCheckboxComponent, selector: "tb-checkbox", inputs: ["disabled", "trueValue", "falseValue"], outputs: ["valueChange"] }, { type: i3.MatFormField, selector: "mat-form-field", inputs: ["color", "floatLabel", "appearance", "hideRequiredMarker", "hintLabel"], exportAs: ["matFormField"] }, { type: i4$1.MatSelect, selector: "mat-select", inputs: ["disabled", "disableRipple", "tabIndex"], exportAs: ["matSelect"] }, { type: i5.MatOption, selector: "mat-option", exportAs: ["matOption"] }, { type: i3$1.MatCheckbox, selector: "mat-checkbox", inputs: ["disableRipple", "color", "tabIndex", "aria-label", "aria-labelledby", "id", "labelPosition", "name", "required", "checked", "disabled", "indeterminate", "aria-describedby", "value"], outputs: ["change", "indeterminateChange"], exportAs: ["matCheckbox"] }, { type: i4$2.MatExpansionPanel, selector: "mat-expansion-panel", inputs: ["disabled", "expanded", "hideToggle", "togglePosition"], outputs: ["opened", "closed", "expandedChange", "afterExpand", "afterCollapse"], exportAs: ["matExpansionPanel"] }, { type: i4$2.MatExpansionPanelHeader, selector: "mat-expansion-panel-header", inputs: ["tabIndex", "expandedHeight", "collapsedHeight"] }, { type: i5$2.MatChipList, selector: "mat-chip-list", inputs: ["aria-orientation", "multiple", "compareWith", "value", "required", "placeholder", "disabled", "selectable", "tabIndex", "errorStateMatcher"], outputs: ["change", "valueChange"], exportAs: ["matChipList"] }, { type: i5$1.JsFuncComponent, selector: "tb-js-func", inputs: ["functionName", "functionArgs", "validationArgs", "resultType", "disabled", "fillHeight", "editorCompleter", "globalVariables", "disableUndefinedCheck", "helpId", "noValidate", "required"] }], directives: [{ type: i2.ɵNgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i7.DefaultFlexDirective, selector: "  [fxFlex], [fxFlex.xs], [fxFlex.sm], [fxFlex.md],  [fxFlex.lg], [fxFlex.xl], [fxFlex.lt-sm], [fxFlex.lt-md],  [fxFlex.lt-lg], [fxFlex.lt-xl], [fxFlex.gt-xs], [fxFlex.gt-sm],  [fxFlex.gt-md], [fxFlex.gt-lg]", inputs: ["fxFlex", "fxFlex.xs", "fxFlex.sm", "fxFlex.md", "fxFlex.lg", "fxFlex.xl", "fxFlex.lt-sm", "fxFlex.lt-md", "fxFlex.lt-lg", "fxFlex.lt-xl", "fxFlex.gt-xs", "fxFlex.gt-sm", "fxFlex.gt-md", "fxFlex.gt-lg"] }, { type: i10.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i3$7.MatDialogContent, selector: "[mat-dialog-content], mat-dialog-content, [matDialogContent]" }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i7.DefaultLayoutGapDirective, selector: "  [fxLayoutGap], [fxLayoutGap.xs], [fxLayoutGap.sm], [fxLayoutGap.md],  [fxLayoutGap.lg], [fxLayoutGap.xl], [fxLayoutGap.lt-sm], [fxLayoutGap.lt-md],  [fxLayoutGap.lt-lg], [fxLayoutGap.lt-xl], [fxLayoutGap.gt-xs], [fxLayoutGap.gt-sm],  [fxLayoutGap.gt-md], [fxLayoutGap.gt-lg]", inputs: ["fxLayoutGap", "fxLayoutGap.xs", "fxLayoutGap.sm", "fxLayoutGap.md", "fxLayoutGap.lg", "fxLayoutGap.xl", "fxLayoutGap.lt-sm", "fxLayoutGap.lt-md", "fxLayoutGap.lt-lg", "fxLayoutGap.lt-xl", "fxLayoutGap.gt-xs", "fxLayoutGap.gt-sm", "fxLayoutGap.gt-md", "fxLayoutGap.gt-lg"] }, { type: i3.MatLabel, selector: "mat-label" }, { type: i11.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["id", "disabled", "required", "type", "value", "readonly", "placeholder", "errorStateMatcher", "aria-describedby"], exportAs: ["matInput"] }, { type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i10.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { type: i2.NumberValueAccessor, selector: "input[type=number][formControlName],input[type=number][formControl],input[type=number][ngModel]" }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i3.MatError, selector: "mat-error", inputs: ["id"] }, { type: i2.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }, { type: i2.FormGroupName, selector: "[formGroupName]", inputs: ["formGroupName"] }, { type: i4$2.MatExpansionPanelTitle, selector: "mat-panel-title" }, { type: i5$2.MatChip, selector: "mat-basic-chip, [mat-basic-chip], mat-chip, [mat-chip]", inputs: ["color", "disableRipple", "tabIndex", "selected", "value", "selectable", "disabled", "removable"], outputs: ["selectionChange", "destroyed", "removed"], exportAs: ["matChip"] }, { type: i5$2.MatChipRemove, selector: "[matChipRemove]" }, { type: i5$2.MatChipInput, selector: "input[matChipInputFor]", inputs: ["matChipInputSeparatorKeyCodes", "placeholder", "id", "matChipInputFor", "matChipInputAddOnBlur", "disabled"], outputs: ["matChipInputTokenEnd"], exportAs: ["matChipInput", "matChipInputFor"] }, { type: i3$7.MatDialogActions, selector: "[mat-dialog-actions], mat-dialog-actions, [matDialogActions]" }, { type: i7.DefaultLayoutAlignDirective, selector: "  [fxLayoutAlign], [fxLayoutAlign.xs], [fxLayoutAlign.sm], [fxLayoutAlign.md],  [fxLayoutAlign.lg], [fxLayoutAlign.xl], [fxLayoutAlign.lt-sm], [fxLayoutAlign.lt-md],  [fxLayoutAlign.lt-lg], [fxLayoutAlign.lt-xl], [fxLayoutAlign.gt-xs], [fxLayoutAlign.gt-sm],  [fxLayoutAlign.gt-md], [fxLayoutAlign.gt-lg]", inputs: ["fxLayoutAlign", "fxLayoutAlign.xs", "fxLayoutAlign.sm", "fxLayoutAlign.md", "fxLayoutAlign.lg", "fxLayoutAlign.xl", "fxLayoutAlign.lt-sm", "fxLayoutAlign.lt-md", "fxLayoutAlign.lt-lg", "fxLayoutAlign.lt-xl", "fxLayoutAlign.gt-xs", "fxLayoutAlign.gt-sm", "fxLayoutAlign.gt-md", "fxLayoutAlign.gt-lg"] }], pipes: { "translate": i4.TranslatePipe, "async": i10.AsyncPipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AggregateLatestMappingDialogComponent, decorators: [{
            type: Component,
            args: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.Store }, { type: i2$1.Router }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [MAT_DIALOG_DATA]
                }] }, { type: i3$7.MatDialogRef }, { type: i2.FormBuilder }, { type: i4.TranslateService }]; } });

class AggregateLatestMappingTableComponent extends PageComponent {
    constructor(store, translate, injector, dialog) {
        super(store);
        this.store = store;
        this.translate = translate;
        this.injector = injector;
    ...
    mappingDisplayValue(aggMapping) {
        let toDisplay = '';
        if (aggMapping.filter) {
            toDisplay += this.translate.instant('tb.rulenode.filter-entities') + ' -> ';
        }
        toDisplay += this.translate.instant(mathFunctionTranslations.get(aggMapping.aggFunction));
        if (aggMapping.aggFunction !== MathFunction.COUNT) {
            toDisplay += '(' + aggMapping.source + ')';
        }
        toDisplay += ' -> ' + aggMapping.target;
        return toDisplay;
    }
    removeAggMapping(index) {
        if (index > -1) {
    ...
    editAggMapping($event, aggMapping) {
        this.openAggMappingDialog($event, aggMapping);
    }
    openAggMappingDialog($event, mapping) {
        if ($event) {
        ...
        }).afterClosed().subscribe((newMapping) => {
            if (newMapping) {
                if (isAdd) {
...
AggregateLatestMappingTableComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AggregateLatestMappingTableComponent, deps: [{ token: i1.Store }, { token: i4.TranslateService }, { token: i0.Injector }, { token: i3$7.MatDialog }], target: i0.ɵɵFactoryTarget.Component });
AggregateLatestMappingTableComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: AggregateLatestMappingTableComponent, selector: "tb-agg-latest-mapping-table", inputs: { disabled: "disabled", required: "required" }, providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => AggregateLatestMappingTableComponent),
            multi: true
        }
    ], usesInheritance: true, ngImport: i0, template: "<section class=\"tb-agg-latest-mapping-table\" fxLayout=\"column\">\n  <label translate class=\"tb-title no-padding\">tb.rulenode.mappings</label>\n  <div class=\"body\">\n    <div class=\"row mat-elevation-z1\" fxFlex fxLayout=\"row\" fxLayoutAlign=\"start center\"\n         *ngFor=\"let aggMapping of mappings; let $index = index\">\n      <span class=\"cell tb-agg-mapping-display-value\" fxFlex>{{ mappingDisplayValue(aggMapping)}}</span>\n      <button [fxShow]=\"!disabled\"\n              [disabled]=\"isLoading$ | async\"\n              mat-icon-button color=\"primary\" type=\"button\"\n              (click)=\"editAggMapping($event, aggMapping)\"\n              matTooltip=\"{{'tb.rulenode.edit-mapping' | translate}}\"\n              matTooltipPosition=\"above\">\n        <mat-icon>edit</mat-icon>\n      </button>\n      <button [fxShow]=\"!disabled\"\n              [disabled]=\"isLoading$ | async\"\n              mat-icon-button color=\"primary\" type=\"button\"\n              (click)=\"removeAggMapping($index)\"\n              matTooltip=\"{{'tb.rulenode.remove-mapping' | translate}}\"\n              matTooltipPosition=\"above\">\n        <mat-icon>close</mat-icon>\n      </button>\n    </div>\n  </div>\n  <span [fxShow]=\"!mappings.length\"\n        fxLayoutAlign=\"center center\" [ngClass]=\"{'disabled': disabled, 'required': required}\"\n        class=\"no-data-found\" translate>tb.rulenode.add-mapping-prompt</span>\n  <div style=\"padding-top: 20px;\">\n    <button [fxShow]=\"!disabled\" [disabled]=\"isLoading$ | async\" type=\"button\"\n            mat-raised-button color=\"primary\" (click)=\"addAggMapping($event)\"\n            matTooltip=\"{{ 'tb.rulenode.add-mapping' | translate }}\"\n            matTooltipPosition=\"above\">\n      <mat-icon>add</mat-icon>\n      {{ 'action.add' | translate }}\n    </button>\n  </div>\n</section>\n", styles: [":host .tb-agg-latest-mapping-table .body{padding-left:5px;padding-right:5px;max-height:300px;overflow:auto}:host .tb-agg-latest-mapping-table .body .row{padding:0 0 0 5px;margin:5px 5px 5px 0;max-height:40px}:host .tb-agg-latest-mapping-table .body .cell{padding-left:5px;padding-right:5px}:host .tb-agg-latest-mapping-table .body .cell.tb-agg-mapping-display-value{font-size:14px;line-height:16px;color:#000000b3}:host .tb-agg-latest-mapping-table span.no-data-found{position:relative;height:40px;text-transform:uppercase;display:flex}:host .tb-agg-latest-mapping-table span.no-data-found.disabled{color:#00000061}:host .tb-agg-latest-mapping-table span.no-data-found.required{color:#dd2c00}\n"], components: [{ type: i6.MatButton, selector: "button[mat-button], button[mat-raised-button], button[mat-icon-button],             button[mat-fab], button[mat-mini-fab], button[mat-stroked-button],             button[mat-flat-button]", inputs: ["disabled", "disableRipple", "color"], exportAs: ["matButton"] }, { type: i6$1.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i10.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { type: i7.DefaultFlexDirective, selector: "  [fxFlex], [fxFlex.xs], [fxFlex.sm], [fxFlex.md],  [fxFlex.lg], [fxFlex.xl], [fxFlex.lt-sm], [fxFlex.lt-md],  [fxFlex.lt-lg], [fxFlex.lt-xl], [fxFlex.gt-xs], [fxFlex.gt-sm],  [fxFlex.gt-md], [fxFlex.gt-lg]", inputs: ["fxFlex", "fxFlex.xs", "fxFlex.sm", "fxFlex.md", "fxFlex.lg", "fxFlex.xl", "fxFlex.lt-sm", "fxFlex.lt-md", "fxFlex.lt-lg", "fxFlex.lt-xl", "fxFlex.gt-xs", "fxFlex.gt-sm", "fxFlex.gt-md", "fxFlex.gt-lg"] }, { type: i7.DefaultLayoutAlignDirective, selector: "  [fxLayoutAlign], [fxLayoutAlign.xs], [fxLayoutAlign.sm], [fxLayoutAlign.md],  [fxLayoutAlign.lg], [fxLayoutAlign.xl], [fxLayoutAlign.lt-sm], [fxLayoutAlign.lt-md],  [fxLayoutAlign.lt-lg], [fxLayoutAlign.lt-xl], [fxLayoutAlign.gt-xs], [fxLayoutAlign.gt-sm],  [fxLayoutAlign.gt-md], [fxLayoutAlign.gt-lg]", inputs: ["fxLayoutAlign", "fxLayoutAlign.xs", "fxLayoutAlign.sm", "fxLayoutAlign.md", "fxLayoutAlign.lg", "fxLayoutAlign.xl", "fxLayoutAlign.lt-sm", "fxLayoutAlign.lt-md", "fxLayoutAlign.lt-lg", "fxLayoutAlign.lt-xl", "fxLayoutAlign.gt-xs", "fxLayoutAlign.gt-sm", "fxLayoutAlign.gt-md", "fxLayoutAlign.gt-lg"] }, { type: i9$1.DefaultShowHideDirective, selector: "  [fxShow], [fxShow.print],  [fxShow.xs], [fxShow.sm], [fxShow.md], [fxShow.lg], [fxShow.xl],  [fxShow.lt-sm], [fxShow.lt-md], [fxShow.lt-lg], [fxShow.lt-xl],  [fxShow.gt-xs], [fxShow.gt-sm], [fxShow.gt-md], [fxShow.gt-lg],  [fxHide], [fxHide.print],  [fxHide.xs], [fxHide.sm], [fxHide.md], [fxHide.lg], [fxHide.xl],  [fxHide.lt-sm], [fxHide.lt-md], [fxHide.lt-lg], [fxHide.lt-xl],  [fxHide.gt-xs], [fxHide.gt-sm], [fxHide.gt-md], [fxHide.gt-lg]", inputs: ["fxShow", "fxShow.print", "fxShow.xs", "fxShow.sm", "fxShow.md", "fxShow.lg", "fxShow.xl", "fxShow.lt-sm", "fxShow.lt-md", "fxShow.lt-lg", "fxShow.lt-xl", "fxShow.gt-xs", "fxShow.gt-sm", "fxShow.gt-md", "fxShow.gt-lg", "fxHide", "fxHide.print", "fxHide.xs", "fxHide.sm", "fxHide.md", "fxHide.lg", "fxHide.xl", "fxHide.lt-sm", "fxHide.lt-md", "fxHide.lt-lg", "fxHide.lt-xl", "fxHide.gt-xs", "fxHide.gt-sm", "fxHide.gt-md", "fxHide.gt-lg"] }, { type: i12.MatTooltip, selector: "[matTooltip]", exportAs: ["matTooltip"] }, { type: i10.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { type: i9$1.DefaultClassDirective, selector: "  [ngClass], [ngClass.xs], [ngClass.sm], [ngClass.md], [ngClass.lg], [ngClass.xl],  [ngClass.lt-sm], [ngClass.lt-md], [ngClass.lt-lg], [ngClass.lt-xl],  [ngClass.gt-xs], [ngClass.gt-sm], [ngClass.gt-md], [ngClass.gt-lg]", inputs: ["ngClass", "ngClass.xs", "ngClass.sm", "ngClass.md", "ngClass.lg", "ngClass.xl", "ngClass.lt-sm", "ngClass.lt-md", "ngClass.lt-lg", "ngClass.lt-xl", "ngClass.gt-xs", "ngClass.gt-sm", "ngClass.gt-md", "ngClass.gt-lg"] }], pipes: { "async": i10.AsyncPipe, "translate": i4.TranslatePipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AggregateLatestMappingTableComponent, decorators: [{
            type: Component,
            args: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.Store }, { type: i4.TranslateService }, { type: i0.Injector }, { type: i3$7.MatDialog }]; }, propDecorators: { disabled: [{
                type: Input
            }], required: [{
                type: Input
            }] } });

const intervalValidators$1 = [Validators.required,
    Validators.min(1), Validators.max(2147483647)];
class AggregateLatestConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
    ...
    onConfigurationSet(configuration) {
        this.aggregateLatestConfigForm = this.fb.group({
            periodValue: [configuration ? configuration.periodValue : null, intervalValidators$1],
...
AggregateLatestConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AggregateLatestConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
AggregateLatestConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: AggregateLatestConfigComponent, selector: "tb-analytics-node-aggregate-latest-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"aggregateLatestConfigForm\" fxLayout=\"column\">\n  <div fxLayout=\"column\" fxLayout.gt-sm=\"row\" fxLayoutGap.gt-sm=\"8px\">\n    <mat-form-field fxFlex class=\"mat-block\">\n      <mat-label translate>tb.rulenode.execution-period-value</mat-label>\n      <input type=\"number\" step=\"1\" min=\"1\" max=\"2147483647\" matInput formControlName=\"periodValue\" required>\n      <mat-error *ngIf=\"aggregateLatestConfigForm.get('periodValue').hasError('required')\">\n        {{ 'tb.rulenode.execution-period-value-required' | translate }}\n      </mat-error>\n      <mat-error *ngIf=\"aggregateLatestConfigForm.get('periodValue').hasError('min')\">\n        {{ 'tb.rulenode.time-value-range' | translate }}\n      </mat-error>\n      <mat-error *ngIf=\"aggregateLatestConfigForm.get('periodValue').hasError('max')\">\n        {{ 'tb.rulenode.time-value-range' | translate }}\n      </mat-error>\n    </mat-form-field>\n    <mat-form-field fxFlex class=\"mat-block\">\n      <mat-label translate>tb.rulenode.execution-period-time-unit</mat-label>\n      <mat-select formControlName=\"periodTimeUnit\" required>\n        <mat-option *ngFor=\"let timeUnit of aggPeriodTimeUnits\" [value]=\"timeUnit\">\n          {{ timeUnitsTranslationMap.get(timeUnit) | translate }}\n        </mat-option>\n      </mat-select>\n    </mat-form-field>\n  </div>\n  <div formGroupName=\"parentEntitiesQuery\">\n    <mat-expansion-panel [expanded]=\"true\">\n      <mat-expansion-panel-header>\n        <mat-panel-title translate>tb.rulenode.entities</mat-panel-title>\n      </mat-expansion-panel-header>\n        <mat-radio-group formControlName=\"type\" fxLayout=\"row\" fxLayoutGap=\"8px\"\n                         style=\"padding-top: 16px; padding-bottom: 16px;\">\n          <mat-radio-button [value]=\"'single'\" color=\"primary\">\n            <span translate>tb.rulenode.single-entity</span>\n          </mat-radio-button>\n          <mat-radio-button [value]=\"'group'\" color=\"primary\">\n            <span translate>tb.rulenode.group-of-entities</span>\n          </mat-radio-button>\n          <mat-radio-button [value]=\"'relationsQuery'\" color=\"primary\">\n            <span translate>tb.rulenode.relations-query</span>\n          </mat-radio-button>\n        </mat-radio-group>\n        <section *ngIf=\"aggregateLatestConfigForm.get('parentEntitiesQuery.type').value === 'relationsQuery'\"\n                 fxLayout=\"column\">\n          <label translate class=\"tb-title tb-required\">tb.rulenode.root-entity</label>\n          <tb-entity-select\n            required\n            formControlName=\"rootEntityId\">\n          </tb-entity-select>\n          <label translate class=\"tb-title tb-required\">tb.rulenode.relations-query</label>\n          <tb-relations-query-config\n            style=\"padding-bottom: 15px;\"\n            formControlName=\"relationsQuery\">\n          </tb-relations-query-config>\n        </section>\n        <tb-entity-select\n          *ngIf=\"aggregateLatestConfigForm.get('parentEntitiesQuery.type').value === 'single'\"\n          required\n          formControlName=\"entityId\">\n        </tb-entity-select>\n        <tb-entity-group-select\n          *ngIf=\"aggregateLatestConfigForm.get('parentEntitiesQuery.type').value === 'group'\"\n          required\n          formControlName=\"entityGroupId\"\n          placeholderText=\"entity-group.select-entity-group\"\n          notFoundText=\"entity-group.no-entity-groups-matching\"\n          requiredText=\"entity-group.target-entity-group-required\">\n        </tb-entity-group-select>\n    </mat-expansion-panel>\n    <mat-expansion-panel *ngIf=\"aggregateLatestConfigForm.get('parentEntitiesQuery.type').value === 'relationsQuery' ||\n                                aggregateLatestConfigForm.get('parentEntitiesQuery.type').value === 'single'\"\n                         [expanded]=\"true\">\n      <mat-expansion-panel-header>\n        <mat-panel-title translate>tb.rulenode.child-entities</mat-panel-title>\n      </mat-expansion-panel-header>\n      <label translate class=\"tb-title tb-required\">tb.rulenode.relations-query</label>\n      <tb-relations-query-config\n        style=\"padding-bottom: 15px;\"\n        formControlName=\"childRelationsQuery\">\n      </tb-relations-query-config>\n    </mat-expansion-panel>\n  </div>\n  <mat-expansion-panel [expanded]=\"true\">\n    <mat-expansion-panel-header>\n      <mat-panel-title translate>tb.rulenode.agg-latest-mappings</mat-panel-title>\n    </mat-expansion-panel-header>\n    <tb-agg-latest-mapping-table\n      required\n      formControlName=\"aggMappings\"\n      style=\"padding-bottom: 15px;\">\n    </tb-agg-latest-mapping-table>\n  </mat-expansion-panel>\n</section>\n", styles: [":host .mat-expansion-panel{margin:0 6px 16px}\n"], components: [{ type: i3.MatFormField, selector: "mat-form-field", inputs: ["color", "floatLabel", "appearance", "hideRequiredMarker", "hintLabel"], exportAs: ["matFormField"] }, { type: i4$1.MatSelect, selector: "mat-select", inputs: ["disabled", "disableRipple", "tabIndex"], exportAs: ["matSelect"] }, { type: i5.MatOption, selector: "mat-option", exportAs: ["matOption"] }, { type: i4$2.MatExpansionPanel, selector: "mat-expansion-panel", inputs: ["disabled", "expanded", "hideToggle", "togglePosition"], outputs: ["opened", "closed", "expandedChange", "afterExpand", "afterCollapse"], exportAs: ["matExpansionPanel"] }, { type: i4$2.MatExpansionPanelHeader, selector: "mat-expansion-panel-header", inputs: ["tabIndex", "expandedHeight", "collapsedHeight"] }, { type: i7$8.MatRadioButton, selector: "mat-radio-button", inputs: ["disableRipple", "tabIndex"], exportAs: ["matRadioButton"] }, { type: i8$1.EntitySelectComponent, selector: "tb-entity-select", inputs: ["allowedEntityTypes", "useAliasEntityTypes", "operation", "required", "disabled"] }, { type: RelationsQueryConfigComponent, selector: "tb-relations-query-config", inputs: ["disabled", "required"] }, { type: i10$1.EntityGroupSelectComponent, selector: "tb-entity-group-select", inputs: ["allowedGroupTypes", "excludeGroupTypes", "defaultGroupType", "excludeGroupIds", "excludeGroupAll", "placeholderText", "notFoundText", "requiredText", "ownerId", "required", "disabled"], outputs: ["currentGroupType", "currentGroupInfo"] }, { type: AggregateLatestMappingTableComponent, selector: "tb-agg-latest-mapping-table", inputs: ["disabled", "required"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i7.DefaultLayoutGapDirective, selector: "  [fxLayoutGap], [fxLayoutGap.xs], [fxLayoutGap.sm], [fxLayoutGap.md],  [fxLayoutGap.lg], [fxLayoutGap.xl], [fxLayoutGap.lt-sm], [fxLayoutGap.lt-md],  [fxLayoutGap.lt-lg], [fxLayoutGap.lt-xl], [fxLayoutGap.gt-xs], [fxLayoutGap.gt-sm],  [fxLayoutGap.gt-md], [fxLayoutGap.gt-lg]", inputs: ["fxLayoutGap", "fxLayoutGap.xs", "fxLayoutGap.sm", "fxLayoutGap.md", "fxLayoutGap.lg", "fxLayoutGap.xl", "fxLayoutGap.lt-sm", "fxLayoutGap.lt-md", "fxLayoutGap.lt-lg", "fxLayoutGap.lt-xl", "fxLayoutGap.gt-xs", "fxLayoutGap.gt-sm", "fxLayoutGap.gt-md", "fxLayoutGap.gt-lg"] }, { type: i7.DefaultFlexDirective, selector: "  [fxFlex], [fxFlex.xs], [fxFlex.sm], [fxFlex.md],  [fxFlex.lg], [fxFlex.xl], [fxFlex.lt-sm], [fxFlex.lt-md],  [fxFlex.lt-lg], [fxFlex.lt-xl], [fxFlex.gt-xs], [fxFlex.gt-sm],  [fxFlex.gt-md], [fxFlex.gt-lg]", inputs: ["fxFlex", "fxFlex.xs", "fxFlex.sm", "fxFlex.md", "fxFlex.lg", "fxFlex.xl", "fxFlex.lt-sm", "fxFlex.lt-md", "fxFlex.lt-lg", "fxFlex.lt-xl", "fxFlex.gt-xs", "fxFlex.gt-sm", "fxFlex.gt-md", "fxFlex.gt-lg"] }, { type: i3.MatLabel, selector: "mat-label" }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i2.MinValidator, selector: "input[type=number][min][formControlName],input[type=number][min][formControl],input[type=number][min][ngModel]", inputs: ["min"] }, { type: i2.MaxValidator, selector: "input[type=number][max][formControlName],input[type=number][max][formControl],input[type=number][max][ngModel]", inputs: ["max"] }, { type: i2.NumberValueAccessor, selector: "input[type=number][formControlName],input[type=number][formControl],input[type=number][ngModel]" }, { type: i11.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["id", "disabled", "required", "type", "value", "readonly", "placeholder", "errorStateMatcher", "aria-describedby"], exportAs: ["matInput"] }, { type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i10.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i3.MatError, selector: "mat-error", inputs: ["id"] }, { type: i10.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { type: i2.FormGroupName, selector: "[formGroupName]", inputs: ["formGroupName"] }, { type: i4$2.MatExpansionPanelTitle, selector: "mat-panel-title" }, { type: i7$8.MatRadioGroup, selector: "mat-radio-group", exportAs: ["matRadioGroup"] }], pipes: { "translate": i4.TranslatePipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AggregateLatestConfigComponent, decorators: [{
            type: Component,
            args: [{
...
class AlarmsCountMappingDialogComponent extends DialogComponent {
    constructor(store, router, data, dialogRef, fb, translate) {
        super(store, router, dialogRef);
        this.store = store;
        this.router = router;
        ...
        this.separatorKeysCodes = [ENTER, COMMA, SEMICOLON];
        this.alarmStatusTranslationsMap = alarmStatusTranslations;
        this.alarmSeverityTranslationsMap = alarmSeverityTranslations;
        this.displayStatusFn = this.displayStatus.bind(this);
        this.alarmStatusList = [];
        this.alarmStatusSearchText = '';
        this.displaySeverityFn = this.displaySeverity.bind(this);
        this.alarmSeverityList = [];
        this.alarmSeveritySearchText = '';
        this.isAdd = data.isAdd;
        this.mapping = data.mapping;
        if (this.isAdd && !this.mapping) {
            this.mapping = {
        ...
        this.statusFormControl = new FormControl('');
        this.severityFormControl = new FormControl('');
        this.filteredAlarmStatus = this.statusFormControl.valueChanges
            .pipe(startWith(''), map((value) => value ? value : ''), mergeMap(name => this.fetchAlarmStatus(name)), share());
        this.filteredAlarmSeverity = this.severityFormControl.valueChanges
            .pipe(startWith(''), map((value) => value ? value : ''), mergeMap(name => this.fetchAlarmSeverity(name)), share());
    }
    ngOnInit() {
    ...
    removeKey(key, keysField) {
        const keys = this.alarmsCountMappingFormGroup.get(keysField).value;
        const index = keys.indexOf(key);
        if (index >= 0) {
            keys.splice(index, 1);
    ...
    addKey(event, keysField) {
        ...
        if ((value || '').trim()) {
            value = value.trim();
            let keys = this.alarmsCountMappingFormGroup.get(keysField).value;
            if (!keys || keys.indexOf(value) === -1) {
                if (!keys) {
                    keys = [];
                }
    ...
    addAlarmStatus(status) {
        let alarmStatusList = this.alarmsCountMappingFormGroup.get('statusList').value;
        if (!alarmStatusList) {
            alarmStatusList = [];
        }
        const index = alarmStatusList.indexOf(status);
    ...
    fetchAlarmSeverity(searchText) {
        ...
        if (this.alarmSeveritySearchText && this.alarmSeveritySearchText.length) {
            ...
            return of(alarmSeverityList.filter(field => this.translate.instant(alarmSeverityTranslations.get(AlarmSeverity[field])).toUpperCase().includes(search)));
        }
        else {
            return of(alarmSeverityList);
        }
    }
    alarmSeveritySelected(event) {
        this.addAlarmSeverity(event.option.value);
        this.clearAlarmSeverity('');
    }
    addAlarmSeverity(severity) {
        let alarmSeverityList = this.alarmsCountMappingFormGroup.get('severityList').value;
...
AlarmsCountMappingDialogComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AlarmsCountMappingDialogComponent, deps: [{ token: i1.Store }, { token: i2$1.Router }, { token: MAT_DIALOG_DATA }, { token: i3$7.MatDialogRef }, { token: i2.FormBuilder }, { token: i4.TranslateService }], target: i0.ɵɵFactoryTarget.Component });
AlarmsCountMappingDialogComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: AlarmsCountMappingDialogComponent, selector: "tb-alarms-count-mapping-dialog", viewQueries: [{ propertyName: "alarmStatusInput", first: true, predicate: ["alarmStatusInput"], descendants: true }, { propertyName: "alarmSeverityInput", first: true, predicate: ["alarmSeverityInput"], descendants: true }], usesInheritance: true, ngImport: i0, template: "<!--\n\n    ThingsBoard, Inc. (\"COMPANY\") CONFIDENTIAL\n\n    Copyright \u00A9 2016-2020 ThingsBoard, Inc. All Rights Reserved.\n\n    NOTICE: All information contained herein is, and remains\n    the property of ThingsBoard, Inc. and its suppliers,\n    if any.  The intellectual and technical concepts contained\n    herein are proprietary to ThingsBoard, Inc.\n    and its suppliers and may be covered by U.S. and Foreign Patents,\n    patents in process, and are protected by trade secret or copyright law.\n\n    Dissemination of this information or reproduction of this material is strictly forbidden\n    unless prior written permission is obtained from COMPANY.\n\n    Access to the source code contained herein is hereby forbidden to anyone except current COMPANY employees,\n    managers or contractors who have executed Confidentiality and Non-disclosure agreements\n    explicitly covering such access.\n\n    The copyright notice above does not evidence any actual or intended publication\n    or disclosure  of  this source code, which includes\n    information that is confidential and/or proprietary, and is a trade secret, of  COMPANY.\n    ANY REPRODUCTION, MODIFICATION, DISTRIBUTION, PUBLIC  PERFORMANCE,\n    OR PUBLIC DISPLAY OF OR THROUGH USE  OF THIS  SOURCE CODE  WITHOUT\n    THE EXPRESS WRITTEN CONSENT OF COMPANY IS STRICTLY PROHIBITED,\n    AND IN VIOLATION OF APPLICABLE LAWS AND INTERNATIONAL TREATIES.\n    THE RECEIPT OR POSSESSION OF THIS SOURCE CODE AND/OR RELATED INFORMATION\n    DOES NOT CONVEY OR IMPLY ANY RIGHTS TO REPRODUCE, DISCLOSE OR DISTRIBUTE ITS CONTENTS,\n    OR TO MANUFACTURE, USE, OR SELL ANYTHING THAT IT  MAY DESCRIBE, IN WHOLE OR IN PART.\n\n-->\n<form [formGroup]=\"alarmsCountMappingFormGroup\" (ngSubmit)=\"save()\" style=\"width: 650px;\">\n  <mat-toolbar fxLayout=\"row\" color=\"primary\">\n    <h2>{{ (isAdd ? 'tb.rulenode.add-mapping' : 'tb.rulenode.edit-mapping') | translate }}</h2>\n    <span fxFlex></span>\n    <button mat-button mat-icon-button\n            (click)=\"cancel()\"\n            type=\"button\">\n      <mat-icon class=\"material-icons\">close</mat-icon>\n    </button>\n  </mat-toolbar>\n  <mat-progress-bar color=\"warn\" mode=\"indeterminate\" *ngIf=\"isLoading$ | async\">\n  </mat-progress-bar>\n  <div style=\"height: 4px;\" *ngIf=\"!(isLoading$ | async)\"></div>\n  <div mat-dialog-content>\n    <fieldset [disabled]=\"isLoading$ | async\">\n      <div fxFlex fxLayout=\"column\">\n        <mat-form-field fxFlex class=\"mat-block\">\n          <mat-label translate>tb.rulenode.target-telemetry</mat-label>\n          <input required matInput formControlName=\"target\">\n          <mat-error *ngIf=\"alarmsCountMappingFormGroup.get('target').hasError('required')\">\n            {{ 'tb.rulenode.target-telemetry-required' | translate }}\n          </mat-error>\n        </mat-form-field>\n        <label translate class=\"tb-title no-padding\">tb.rulenode.status-filter</label>\n        <mat-form-field floatLabel=\"always\" class=\"mat-block\">\n          <mat-label></mat-label>\n          <mat-chip-list #alarmStatusChipList>\n            <mat-chip\n              *ngFor=\"let alarmStatus of alarmsCountMappingFormGroup.get('statusList').value;\"\n              (removed)=\"removeKey(alarmStatus, 'statusList')\">\n                <span>\n                  <strong>{{alarmStatusTranslationsMap.get(alarmStatus) | translate}}</strong>\n                </span>\n              <mat-icon matChipRemove>close</mat-icon>\n            </mat-chip>\n            <input matInput type=\"text\"\n                   placeholder=\"{{(alarmsCountMappingFormGroup.get('statusList').value.length ?\n                                   'tb.rulenode.add-alarm-status' : 'tb.rulenode.all-statuses') | translate}}\"\n                   style=\"max-width: 200px;\"\n                   #alarmStatusInput\n                   (focusin)=\"onAlarmStatusInputFocus()\"\n                   [formControl]=\"statusFormControl\"\n                   matAutocompleteOrigin\n                   #originAlarmStatus=\"matAutocompleteOrigin\"\n                   [matAutocompleteConnectedTo]=\"originAlarmStatus\"\n                   [matAutocomplete]=\"alarmStatusAutocomplete\"\n                   [matChipInputFor]=\"alarmStatusChipList\">\n          </mat-chip-list>\n          <mat-autocomplete #alarmStatusAutocomplete=\"matAutocomplete\"\n                            class=\"tb-autocomplete\"\n                            (optionSelected)=\"alarmStatusSelected($event)\"\n                            [displayWith]=\"displayStatusFn\">\n            <mat-option *ngFor=\"let status of filteredAlarmStatus | async\" [value]=\"status\">\n              <span [innerHTML]=\"alarmStatusTranslationsMap.get(status) | translate | highlight:alarmStatusSearchText\"></span>\n            </mat-option>\n            <mat-option *ngIf=\"(filteredAlarmStatus | async)?.length === 0\" [value]=\"null\" class=\"tb-not-found\">\n              <div class=\"tb-not-found-content\" (click)=\"$event.stopPropagation()\">\n                <div>\n                  <span translate>tb.rulenode.no-alarm-status-matching</span>\n                </div>\n              </div>\n            </mat-option>\n          </mat-autocomplete>\n        </mat-form-field>\n        <label translate class=\"tb-title no-padding\">tb.rulenode.severity-filter</label>\n        <mat-form-field floatLabel=\"always\" class=\"mat-block\">\n          <mat-label></mat-label>\n          <mat-chip-list #alarmSeverityChipList>\n            <mat-chip\n              *ngFor=\"let alarmSeverity of alarmsCountMappingFormGroup.get('severityList').value;\"\n              (removed)=\"removeKey(alarmSeverity, 'severityList')\">\n                <span>\n                  <strong>{{alarmSeverityTranslationsMap.get(alarmSeverity) | translate}}</strong>\n                </span>\n              <mat-icon matChipRemove>close</mat-icon>\n            </mat-chip>\n            <input matInput type=\"text\"\n                   placeholder=\"{{(alarmsCountMappingFormGroup.get('severityList').value.length ?\n                                   'tb.rulenode.add-alarm-severity' : 'tb.rulenode.all-severities') | translate}}\"\n                   style=\"max-width: 200px;\"\n                   #alarmSeverityInput\n                   (focusin)=\"onAlarmSeverityInputFocus()\"\n                   [formControl]=\"severityFormControl\"\n                   matAutocompleteOrigin\n                   #originAlarmSeverity=\"matAutocompleteOrigin\"\n                   [matAutocompleteConnectedTo]=\"originAlarmSeverity\"\n                   [matAutocomplete]=\"alarmSeverityAutocomplete\"\n                   [matChipInputFor]=\"alarmSeverityChipList\">\n          </mat-chip-list>\n          <mat-autocomplete #alarmSeverityAutocomplete=\"matAutocomplete\"\n                            class=\"tb-autocomplete\"\n                            (optionSelected)=\"alarmSeveritySelected($event)\"\n                            [displayWith]=\"displaySeverityFn\">\n            <mat-option *ngFor=\"let severity of filteredAlarmSeverity | async\" [value]=\"severity\">\n              <span [innerHTML]=\"alarmSeverityTranslationsMap.get(severity) | translate | highlight:alarmSeveritySearchText\"></span>\n            </mat-option>\n            <mat-option *ngIf=\"(filteredAlarmSeverity | async)?.length === 0\" [value]=\"null\" class=\"tb-not-found\">\n              <div class=\"tb-not-found-content\" (click)=\"$event.stopPropagation()\">\n                <div>\n                  <span translate>tb.rulenode.no-alarm-severity-matching</span>\n                </div>\n              </div>\n            </mat-option>\n          </mat-autocomplete>\n        </mat-form-field>\n        <label translate class=\"tb-title no-padding\">tb.rulenode.type-filter</label>\n        <mat-form-field floatLabel=\"always\" class=\"mat-block\">\n          <mat-label></mat-label>\n          <mat-chip-list #typesChipList>\n            <mat-chip\n              *ngFor=\"let key of alarmsCountMappingFormGroup.get('typesList').value;\"\n              (removed)=\"removeKey(key, 'typesList')\">\n              {{key}}\n              <mat-icon matChipRemove>close</mat-icon>\n            </mat-chip>\n            <input matInput type=\"text\"\n                   placeholder=\"{{(alarmsCountMappingFormGroup.get('typesList').value.length ?\n                                   'tb.rulenode.add-alarm-type' : 'tb.rulenode.all-types') | translate}}\"\n                   style=\"max-width: 200px;\"\n                   [matChipInputFor]=\"typesChipList\"\n                   [matChipInputSeparatorKeyCodes]=\"separatorKeysCodes\"\n                   (matChipInputTokenEnd)=\"addKey($event, 'typesList')\"\n                   [matChipInputAddOnBlur]=\"true\">\n          </mat-chip-list>\n        </mat-form-field>\n        <mat-checkbox\n          [(ngModel)]=\"specifyInterval\"\n          [ngModelOptions]=\"{ standalone: true}\"\n          (ngModelChange)=\"specifyIntervalChange()\" style=\"display: block; margin-bottom: 16px;\">\n          {{ 'tb.rulenode.specify-interval' | translate }}\n        </mat-checkbox>\n        <tb-timeinterval\n          *ngIf=\"specifyInterval\"\n          predefinedName=\"timewindow.last\"\n          formControlName=\"latestInterval\"\n          style=\"padding-top: 8px\">\n        </tb-timeinterval>\n      </div>\n    </fieldset>\n  </div>\n  <div mat-dialog-actions fxLayout=\"row\" fxLayoutAlign=\"end center\">\n    <span fxFlex></span>\n    <button mat-button mat-raised-button color=\"primary\"\n            type=\"submit\"\n            [disabled]=\"(isLoading$ | async) || alarmsCountMappingFormGroup.invalid || !alarmsCountMappingFormGroup.dirty\">\n      {{ (isAdd ? 'action.add' : 'action.save') | translate }}\n    </button>\n    <button mat-button color=\"primary\"\n            style=\"margin-right: 20px;\"\n            type=\"button\"\n            [disabled]=\"(isLoading$ | async)\"\n            (click)=\"cancel()\" cdkFocusInitial>\n      {{ 'action.cancel' | translate }}\n    </button>\n  </div>\n</form>\n", components: [{ type: i6$2.MatToolbar, selector: "mat-toolbar", inputs: ["color"], exportAs: ["matToolbar"] }, { type: i6.MatButton, selector: "button[mat-button], button[mat-raised-button], button[mat-icon-button],             button[mat-fab], button[mat-mini-fab], button[mat-stroked-button],             button[mat-flat-button]", inputs: ["disabled", "disableRipple", "color"], exportAs: ["matButton"] }, { type: i6$1.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { type: i9$2.MatProgressBar, selector: "mat-progress-bar", inputs: ["color", "mode", "value", "bufferValue"], outputs: ["animationEnd"], exportAs: ["matProgressBar"] }, { type: i3.MatFormField, selector: "mat-form-field", inputs: ["color", "floatLabel", "appearance", "hideRequiredMarker", "hintLabel"], exportAs: ["matFormField"] }, { type: i5$2.MatChipList, selector: "mat-chip-list", inputs: ["aria-orientation", "multiple", "compareWith", "value", "required", "placeholder", "disabled", "selectable", "tabIndex", "errorStateMatcher"], outputs: ["change", "valueChange"], exportAs: ["matChipList"] }, { type: i7$6.MatAutocomplete, selector: "mat-autocomplete", inputs: ["disableRipple"], exportAs: ["matAutocomplete"] }, { type: i5.MatOption, selector: "mat-option", exportAs: ["matOption"] }, { type: i3$1.MatCheckbox, selector: "mat-checkbox", inputs: ["disableRipple", "color", "tabIndex", "aria-label", "aria-labelledby", "id", "labelPosition", "name", "required", "checked", "disabled", "indeterminate", "aria-describedby", "value"], outputs: ["change", "indeterminateChange"], exportAs: ["matCheckbox"] }, { type: i15.TimeintervalComponent, selector: "tb-timeinterval", inputs: ["min", "max", "predefinedName", "isEdit", "hideFlag", "disabled"], outputs: ["hideFlagChange"] }], directives: [{ type: i2.ɵNgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i7.DefaultFlexDirective, selector: "  [fxFlex], [fxFlex.xs], [fxFlex.sm], [fxFlex.md],  [fxFlex.lg], [fxFlex.xl], [fxFlex.lt-sm], [fxFlex.lt-md],  [fxFlex.lt-lg], [fxFlex.lt-xl], [fxFlex.gt-xs], [fxFlex.gt-sm],  [fxFlex.gt-md], [fxFlex.gt-lg]", inputs: ["fxFlex", "fxFlex.xs", "fxFlex.sm", "fxFlex.md", "fxFlex.lg", "fxFlex.xl", "fxFlex.lt-sm", "fxFlex.lt-md", "fxFlex.lt-lg", "fxFlex.lt-xl", "fxFlex.gt-xs", "fxFlex.gt-sm", "fxFlex.gt-md", "fxFlex.gt-lg"] }, { type: i10.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i3$7.MatDialogContent, selector: "[mat-dialog-content], mat-dialog-content, [matDialogContent]" }, { type: i3.MatLabel, selector: "mat-label" }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i11.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["id", "disabled", "required", "type", "value", "readonly", "placeholder", "errorStateMatcher", "aria-describedby"], exportAs: ["matInput"] }, { type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i3.MatError, selector: "mat-error", inputs: ["id"] }, { type: i10.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { type: i5$2.MatChip, selector: "mat-basic-chip, [mat-basic-chip], mat-chip, [mat-chip]", inputs: ["color", "disableRipple", "tabIndex", "selected", "value", "selectable", "disabled", "removable"], outputs: ["selectionChange", "destroyed", "removed"], exportAs: ["matChip"] }, { type: i5$2.MatChipRemove, selector: "[matChipRemove]" }, { type: i7$6.MatAutocompleteTrigger, selector: "input[matAutocomplete], textarea[matAutocomplete]", exportAs: ["matAutocompleteTrigger"] }, { type: i5$2.MatChipInput, selector: "input[matChipInputFor]", inputs: ["matChipInputSeparatorKeyCodes", "placeholder", "id", "matChipInputFor", "matChipInputAddOnBlur", "disabled"], outputs: ["matChipInputTokenEnd"], exportAs: ["matChipInput", "matChipInputFor"] }, { type: i7$6.MatAutocompleteOrigin, selector: "[matAutocompleteOrigin]", exportAs: ["matAutocompleteOrigin"] }, { type: i2.FormControlDirective, selector: "[formControl]", inputs: ["disabled", "formControl", "ngModel"], outputs: ["ngModelChange"], exportAs: ["ngForm"] }, { type: i2.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }, { type: i3$7.MatDialogActions, selector: "[mat-dialog-actions], mat-dialog-actions, [matDialogActions]" }, { type: i7.DefaultLayoutAlignDirective, selector: "  [fxLayoutAlign], [fxLayoutAlign.xs], [fxLayoutAlign.sm], [fxLayoutAlign.md],  [fxLayoutAlign.lg], [fxLayoutAlign.xl], [fxLayoutAlign.lt-sm], [fxLayoutAlign.lt-md],  [fxLayoutAlign.lt-lg], [fxLayoutAlign.lt-xl], [fxLayoutAlign.gt-xs], [fxLayoutAlign.gt-sm],  [fxLayoutAlign.gt-md], [fxLayoutAlign.gt-lg]", inputs: ["fxLayoutAlign", "fxLayoutAlign.xs", "fxLayoutAlign.sm", "fxLayoutAlign.md", "fxLayoutAlign.lg", "fxLayoutAlign.xl", "fxLayoutAlign.lt-sm", "fxLayoutAlign.lt-md", "fxLayoutAlign.lt-lg", "fxLayoutAlign.lt-xl", "fxLayoutAlign.gt-xs", "fxLayoutAlign.gt-sm", "fxLayoutAlign.gt-md", "fxLayoutAlign.gt-lg"] }], pipes: { "translate": i4.TranslatePipe, "async": i10.AsyncPipe, "highlight": i12$1.HighlightPipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AlarmsCountMappingDialogComponent, decorators: [{
            type: Component,
            args: [{
                    ...
                    type: Inject,
                    args: [MAT_DIALOG_DATA]
                }] }, { type: i3$7.MatDialogRef }, { type: i2.FormBuilder }, { type: i4.TranslateService }]; }, propDecorators: { alarmStatusInput: [{
                type: ViewChild,
                args: ['alarmStatusInput', { static: false }]
            }], alarmSeverityInput: [{
                type: ViewChild,
                args: ['alarmSeverityInput', { static: false }]
            }] } });

class AlarmsCountMappingTableComponent extends PageComponent {
    constructor(store, translate, injector, millisecondsToTimeStringPipe, dialog) {
        super(store);
        this.store = store;
        this.translate = translate;
        this.injector = injector;
        this.millisecondsToTimeStringPipe = millisecondsToTimeStringPipe;
        this.dialog = dialog;
        this.propagateChange = null;
    }
    get required() {
    ...
    mappingDisplayValue(alarmsCountMapping) {
    ...
    statusFilterText(statusList, text) {
        const result = [];
        if (statusList && statusList.length) {
            statusList.forEach((status) => result.push(this.translate.instant(alarmStatusTranslations.get(status))));
        }
        return this.updateFilterText(result, text);
    }
    severityFilterText(severityList, text) {
        const result = [];
        if (severityList && severityList.length) {
            severityList.forEach((severity) => result.push(this.translate.instant(alarmSeverityTranslations.get(severity))));
        }
        return this.updateFilterText(result, text);
    }
    typeFilterText(typesList, text) {
        const result = [];
    ...
    updateFilterText(resultList, text) {
    ...
    removeAlarmsCountMapping(index) {
        if (index > -1) {
            this.mappings.splice(index, 1);
            this.updateModel();
        }
    }
    addAlarmsCountMapping($event) {
        this.openAlarmsCountMappingDialog($event);
    }
    editAlarmsCountMapping($event, aggMapping) {
        this.openAlarmsCountMappingDialog($event, aggMapping);
    }
    openAlarmsCountMappingDialog($event, mapping) {
        if ($event) {
            $event.stopPropagation();
        }
        const isAdd = !mapping;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AlarmsCountMappingTableComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.Store }, { type: i4.TranslateService }, { type: i0.Injector }, { type: i3$5.MillisecondsToTimeStringPipe }, { type: i3$7.MatDialog }]; }, propDecorators: { disabled: [{
                type: Input
            }], required: [{
                type: Input
            }] } });
...
const intervalValidators = [Validators.required,
    Validators.min(1), Validators.max(2147483647)];
class AlarmsCountConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
    ...
    updateValidators(emitEvent, trigger) {
        ...
        const parentEntitiesQueryType = parentEntitiesQueryControl.get('type').value;
        const countAlarmsForChildEntities = this.alarmsCountConfigForm.get('countAlarmsForChildEntities').value;
        if (emitEvent) {
            if (trigger === 'parentEntitiesQuery.type') {
                const parentEntitiesQuery = {
                    type: parentEntitiesQueryType
...
class AlarmsCountV2ConfigComponent extends RuleNodeConfigurationComponent {
    constructor(store, fb) {
        super(store);
        this.store = store;
        this.fb = fb;
...
AlarmsCountV2ConfigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AlarmsCountV2ConfigComponent, deps: [{ token: i1.Store }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
AlarmsCountV2ConfigComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: AlarmsCountV2ConfigComponent, selector: "tb-analytics-node-alarms-count-v2-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"alarmsCountConfigForm\" fxLayout=\"column\">\n  <mat-checkbox formControlName=\"countAlarmsForPropagationEntities\" style=\"padding-bottom: 16px;\">\n    {{ 'tb.rulenode.count-alarms-for-propagation-entities' | translate }}\n  </mat-checkbox>\n  <mat-expansion-panel [expanded]=\"true\">\n    <mat-expansion-panel-header>\n      <mat-panel-title translate>tb.rulenode.alarms-count-mappings</mat-panel-title>\n    </mat-expansion-panel-header>\n    <tb-alarms-count-mapping-table\n      required\n      formControlName=\"alarmsCountMappings\"\n      style=\"padding-bottom: 15px;\">\n    </tb-alarms-count-mapping-table>\n  </mat-expansion-panel>\n</section>\n", styles: [":host .mat-expansion-panel{margin:0 6px 16px}\n"], components: [{ type: i3$1.MatCheckbox, selector: "mat-checkbox", inputs: ["disableRipple", "color", "tabIndex", "aria-label", "aria-labelledby", "id", "labelPosition", "name", "required", "checked", "disabled", "indeterminate", "aria-describedby", "value"], outputs: ["change", "indeterminateChange"], exportAs: ["matCheckbox"] }, { type: i4$2.MatExpansionPanel, selector: "mat-expansion-panel", inputs: ["disabled", "expanded", "hideToggle", "togglePosition"], outputs: ["opened", "closed", "expandedChange", "afterExpand", "afterCollapse"], exportAs: ["matExpansionPanel"] }, { type: i4$2.MatExpansionPanelHeader, selector: "mat-expansion-panel-header", inputs: ["tabIndex", "expandedHeight", "collapsedHeight"] }, { type: AlarmsCountMappingTableComponent, selector: "tb-alarms-count-mapping-table", inputs: ["disabled", "required"] }], directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i2.FormControlName, selector: "[formControlName]", inputs: ["disabled", "formControlName", "ngModel"], outputs: ["ngModelChange"] }, { type: i4$2.MatExpansionPanelTitle, selector: "mat-panel-title" }, { type: i4.TranslateDirective, selector: "[translate],[ngx-translate]", inputs: ["translate", "translateParams"] }, { type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }], pipes: { "translate": i4.TranslatePipe } });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: AlarmsCountV2ConfigComponent, decorators: [{
            type: Component,
            args: [{
...
class RulenodeCoreConfigAnalyticsModule {
}
RulenodeCoreConfigAnalyticsModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: RulenodeCoreConfigAnalyticsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
RulenodeCoreConfigAnalyticsModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: RulenodeCoreConfigAnalyticsModule, declarations: [AggregateIncomingConfigComponent,
        AggregateLatestMappingDialogComponent,
        ...
        AlarmsCountV2ConfigComponent], imports: [CommonModule,
        SharedModule,
        RulenodeCoreConfigCommonModule], exports: [AggregateIncomingConfigComponent,
        AggregateLatestConfigComponent,
        AlarmsCountConfigComponent,
        AlarmsCountV2ConfigComponent] });
RulenodeCoreConfigAnalyticsModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: RulenodeCoreConfigAnalyticsModule, imports: [[
            CommonModule,
            SharedModule,
            RulenodeCoreConfigCommonModule
        ]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: RulenodeCoreConfigAnalyticsModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
...
RuleChainOutputComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.14", type: RuleChainOutputComponent, selector: "tb-flow-node-rule-chain-output-config", usesInheritance: true, ngImport: i0, template: "<section [formGroup]=\"ruleChainOutputConfigForm\" fxLayout=\"column\">\n  <div innerHTML=\"{{ 'tb.rulenode.output-node-name-hint' | translate }}\"></div>\n</section>\n", directives: [{ type: i7.DefaultLayoutDirective, selector: "  [fxLayout], [fxLayout.xs], [fxLayout.sm], [fxLayout.md],  [fxLayout.lg], [fxLayout.xl], [fxLayout.lt-sm], [fxLayout.lt-md],  [fxLayout.lt-lg], [fxLayout.lt-xl], [fxLayout.gt-xs], [fxLayout.gt-sm],  [fxLayout.gt-md], [fxLayout.gt-lg]", inputs: ["fxLayout", "fxLayout.xs", "fxLayout.sm", "fxLayout.md", "fxLayout.lg", "fxLayout.xl", "fxLayout.lt-sm", "fxLayout.lt-md", "fxLayout.lt-lg", "fxLayout.lt-xl", "fxLayout.gt-xs", "fxLayout.gt-sm", "fxLayout.gt-md", "fxLayout.gt-lg"] }, { type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }], pipes: { "translate": i4.TranslatePipe } });
    ...
    const enUS = {
        tb: {
            rulenode: {
                ...
                'no-alarm-severity-matching': 'No alarm severity matching were found.',
                propagate: 'Propagate',
                condition: 'Condition',
                details: 'Details',
                'to-string': 'To string',
                ...
                'remove-from-current-groups': 'Remove from current groups',
                'use-report-config-from-message': 'Use report config from message',
                'use-system-reports-server': 'Use system reports server',
                'reports-server-endpoint-url': 'Reports server endpoint URL',
                'reports-server-endpoint-url-is-required': 'Reports server endpoint URL is required.',
                ...
                'math-function': 'Aggregation function',
                'func-min': 'Minimum',
                'func-max': 'Maximum',
                'func-sum': 'Sum',
                'func-avg': 'Average',
                'func-count': 'Count',
                'func-count-unique': 'Count unique',
                ...
                'agg-interval-value': 'Aggregation interval value',
                'agg-interval-value-required': 'Aggregation interval value is required.',
                'agg-interval-time-unit': 'Aggregation interval time unit',
                'auto-create-intervals': 'Create intervals automatically',
                'interval-entities': 'Interval entities',
                'interval-persistence': 'Interval persistence',
                'interval-persistence-policy': 'Interval persistence policy',
                'interval-persist-policy-on-each-check': 'On each check',
                'interval-persist-policy-on-each-check-after-interval-end': 'On each check after interval end',
                'interval-persist-policy-on-each-message': 'On each message',
                'interval-check-value': 'Interval check value',
                'interval-check-value-required': 'Interval check value is required.',
                'interval-check-time-unit': 'Interval check time unit',
                'interval-ttl-value': 'Interval TTL value',
                'interval-ttl-value-required': 'Interval TTL value is required.',
                'interval-ttl-time-unit': 'Interval TTL time unit',
                ...
                'state-persistence-policy': 'State persistence policy',
                'state-persist-policy-on-each-change': 'On each change',
                'state-persist-policy-periodically': 'Periodically',
                'state-persistence-value': 'State persistence value',
                'state-persistence-value-required': 'State persistence value is required.',
                'state-persistence-time-unit': 'State persistence time unit',
                'target-entity-group': 'Target entity group',
                'entity-group-is-message-originator': 'Entity group is message originator',
                'originator-types-filter': 'Originator types filter',
                'single-entity': 'Single entity',
                'group-of-entities': 'Group of entities',
                entities: 'Entities',
                'root-entity': 'Root entity',
                'child-entities-query': 'Child entities query',
                'child-entities': 'Child entities',
                'execution-period-value': 'Execution period value',
                'execution-period-value-required': 'Execution period value is required.',
                'execution-period-time-unit': 'Execution period time unit',
                'agg-latest-mappings': 'Aggregate latest mappings',
                mappings: 'Mappings',
                'edit-mapping': 'Edit mapping',
                'remove-mapping': 'Remove mapping',
                'add-mapping': 'Add mapping',
                'add-mapping-prompt': 'Please add mapping',
                'attribute-scope': 'Attribute scope',
                'default-value': 'Default value',
                'default-value-required': 'Default value is required.',
                'target-telemetry': 'Target telemetry',
                'target-telemetry-required': 'Target telemetry is required.',
                'filter-entities': 'Filter entities',
                'entity-filter': 'Entity filter',
                'fetch-entity-attributes': 'Fetch entity attributes',
                'count-alarms-for-child-entities': 'Count alarms for child entities',
                'count-alarms-for-propagation-entities': 'Count alarms for propagation entities',
                'alarms-count-mappings': 'Alarms count mappings',
                and: 'and',
                ...
                'all-types': 'All types',
                'add-alarm-status': '+Alarm status',
                'add-alarm-severity': '+Alarm severity',
                'add-alarm-type': '+Alarm type',
                'specify-interval': 'Specify interval',
                ...
                'owner-name-pattern': 'Owner name pattern',
                'owner-name-pattern-required': 'Owner name pattern is required',
                'create-owner-if-not-exists': 'Create new owner if not exists',
                'owner-cache-expiration': 'Owners cache expiration time (sec)',
                'owner-cache-expiration-required': 'Owners cache expiration time is required.',
                'owner-cache-expiration-range': 'Owners cache expiration time should be greater than or equal to 0.',
                'owner-cache-expiration-hint': 'Specifies maximum time interval allowed to store found owner records. 0 value means that records will never expire.',
                ...
                'aggregate-period-hour': 'Hour',
                'aggregate-period-day': 'Day',
                'aggregate-period-week': 'Week (Mon - Sun)',
                'aggregate-period-week-sun-sat': 'Week (Sun - Sat)',
                'aggregate-period-month': 'Month',
                'aggregate-period-year': 'Year',
                'aggregate-period-custom': 'Custom',
                ...
                'search-entity-group-for-tenant-only': 'Search entity group on Tenant level only',
...
RuleNodeCoreConfigModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.14", ngImport: i0, type: RuleNodeCoreConfigModule, declarations: [EmptyConfigComponent], imports: [CommonModule,
        ...
        RulenodeCoreConfigAnalyticsModule,
...
export { AddToGroupConfigComponent, AggregateIncomingConfigComponent, AggregateLatestConfigComponent, AlarmsCountConfigComponent, AlarmsCountV2ConfigComponent, AssignCustomerConfigComponent, AttributesConfigComponent, AzureIotHubConfigComponent, CalculateDeltaConfigComponent, ChangeOriginatorConfigComponent, ChangeOwnerConfigComponent, CheckAlarmStatusComponent, CheckMessageConfigComponent, CheckPointConfigComponent, CheckRelationConfigComponent, ClearAlarmConfigComponent, CreateAlarmConfigComponent, CreateRelationConfigComponent, CredentialsConfigComponent, CustomerAttributesConfigComponent, DeleteRelationConfigComponent, DeviceAttributesConfigComponent, DeviceProfileConfigComponent, DeviceRelationsQueryConfigComponent, DuplicateToGroupByNameConfigComponent, DuplicateToGroupConfigComponent, DuplicateToRelatedConfigComponent, EmptyConfigComponent, EntityDetailsConfigComponent, GenerateReportConfigComponent, GeneratorConfigComponent, GetTelemetryFromDatabaseConfigComponent, GpsGeoActionConfigComponent, GpsGeoFilterConfigComponent, IntegrationDownlinkConfigComponent, KafkaConfigComponent, KvMapConfigComponent, LogConfigComponent, MessageTypeConfigComponent, MessageTypesConfigComponent, MqttConfigComponent, MsgCountConfigComponent, MsgDelayConfigComponent, OriginatorAttributesConfigComponent, OriginatorFieldsConfigComponent, OriginatorTypeConfigComponent, PubSubConfigComponent, PushToCloudConfigComponent, PushToEdgeConfigComponent, RabbitMqConfigComponent, RelatedAttributesConfigComponent, RelationsQueryConfigComponent, RemoveFromGroupConfigComponent, RestApiCallConfigComponent, RpcReplyConfigComponent, RpcRequestConfigComponent, RuleChainInputComponent, RuleChainOutputComponent, RuleNodeCoreConfigActionModule, RuleNodeCoreConfigFilterModule, RuleNodeCoreConfigFlowModule, RuleNodeCoreConfigModule, RulenodeCoreConfigAnalyticsModule, RulenodeCoreConfigCommonModule, RulenodeCoreConfigEnrichmentModule, RulenodeCoreConfigTransformModule, SafeHtmlPipe, SaveToCustomTableConfigComponent, ScriptConfigComponent, SendEmailConfigComponent, SendRestApiCallReplyConfigComponent, SendSmsConfigComponent, SnsConfigComponent, SqsConfigComponent, SwitchConfigComponent, TenantAttributesConfigComponent, TimeseriesConfigComponent, ToEmailConfigComponent, TransformScriptConfigComponent, UnassignCustomerConfigComponent };
