...
@Slf4j
public class TbAggLatestNodeTest {
    ...
    public void init() {
        ...
        TbAggLatestNodeConfiguration config = new TbAggLatestNodeConfiguration();
        node = new TbAggLatestNode();
