...
public class JpaBaseEventDaoTest extends AbstractJpaDaoTest {
    ...
    private long createEventsTwoEntitiesTwoTypes(UUID tenantId, UUID entityId1, UUID entityId2, int count) {
    ...
    private long createEventsTwoEntities(UUID tenantId, UUID entityId1, UUID entityId2, int count) {
        for (int i = 0; i < count / 2; i++) {
            UUID eventId1 = Uuids.timeBased();
