...
public class CustomerServiceImpl extends AbstractEntityService implements CustomerService {
    ...
    public Customer saveCustomer(Customer customer) {
        ...
        if (customer.getId() == null) {
            ...
            // User Group 'Users' -> 'User' role -> Read only permissions
            EntityGroup users = entityGroupService.getOrCreateUserGroup(savedCustomer.getTenantId(), savedCustomer.getId(), EntityGroup.GROUP_USERS_NAME);
            ...
            EntityGroup admins = entityGroupService.getOrCreateUserGroup(savedCustomer.getTenantId(), savedCustomer.getId(), EntityGroup.GROUP_ADMINS_NAME);
