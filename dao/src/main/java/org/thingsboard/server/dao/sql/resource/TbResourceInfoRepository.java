...
public interface TbResourceInfoRepository extends JpaRepository<TbResourceInfoEntity, UUID> {
    ...
    @Query("SELECT tr FROM TbResourceInfoEntity tr WHERE " +
            ...
            "AND ((tr.tenantId = :tenantId AND (tr.customerId IS NULL OR tr.customerId = uuid('13814000-1dd2-11b2-8080-808080808080')))" +
    ...
    @Query("SELECT ri FROM TbResourceInfoEntity ri WHERE " +
            "ri.tenantId = :tenantId AND (ri.customerId IS NULL OR ri.customerId = uuid('13814000-1dd2-11b2-8080-808080808080')) " +
