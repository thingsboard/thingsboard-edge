...
public class TenantServiceImpl extends AbstractEntityService implements TenantService {
    ...
    public Tenant saveTenant(Tenant tenant) {
        ...
        if (tenant.getId() == null) {
            ...
            EntityGroup users = entityGroupService.getOrCreateUserGroup(TenantId.SYS_TENANT_ID, savedTenant.getId(), EntityGroup.GROUP_USERS_NAME);
            ...
            EntityGroup admins = entityGroupService.getOrCreateUserGroup(TenantId.SYS_TENANT_ID, savedTenant.getId(), EntityGroup.GROUP_ADMINS_NAME);
