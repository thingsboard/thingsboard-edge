...
public class RoleServiceImpl extends AbstractEntityService implements RoleService {
    ...
    @Override
    public Role findOrCreateEdgeTenantAdminRole() {
        return findOrCreateRole(TenantId.SYS_TENANT_ID, null, RoleType.GENERIC, Role.ROLE_EDGE_TENANT_ADMIN_NAME,
                GroupPermission.EDGE_TENANT_ADMIN_PERMISSIONS, "Autogenerated Edge Tenant Admin role.");
    }

    @Override
    public Role findOrCreateEdgeCustomerUserRole() {
        return findOrCreateRole(TenantId.SYS_TENANT_ID, null, RoleType.GENERIC, Role.ROLE_EDGE_CUSTOMER_USER_NAME,
