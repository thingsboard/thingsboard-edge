...
public class RoleServiceImpl extends AbstractEntityService implements RoleService {
    ...
    @Override
    public Role findOrCreateEdgeCETenantAdminRole(TenantId tenantId) {
        return findOrCreateRole(tenantId, null, RoleType.GENERIC, Role.ROLE_EDGE_CE_TENANT_ADMIN_NAME,
                GroupPermission.EDGE_CE_TENANT_ADMIN_PERMISSIONS, "Autogenerated CE Edge Tenant Admin role.");
    }

    @Override
    public Role findOrCreateEdgeCECustomerUserRole(TenantId tenantId, CustomerId customerId) {
        return findOrCreateRole(tenantId, customerId, RoleType.GENERIC, Role.ROLE_EDGE_CE_CUSTOMER_USER_NAME,
                GroupPermission.EDGE_CE_CUSTOMER_USER_PERMISSIONS,
                "Autogenerated CE Edge Customer User role.");
    }
