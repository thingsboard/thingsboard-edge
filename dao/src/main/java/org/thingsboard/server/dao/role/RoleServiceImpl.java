...
public class RoleServiceImpl extends AbstractEntityService implements RoleService {
    ...
    @Override
    public Role findOrCreateEdgeTenantAdminRole(TenantId tenantId) {
        return findOrCreateRole(tenantId, null, RoleType.GENERIC, Role.ROLE_EDGE_TENANT_ADMIN_NAME,
                GroupPermission.EDGE_TENANT_ADMIN_PERMISSIONS, "Autogenerated Edge Tenant Admin role.");
    }

    @Override
    public Role findOrCreateEdgeTenantUserRole(TenantId tenantId) {
        return findOrCreateRole(tenantId, null, RoleType.GENERIC, Role.ROLE_EDGE_TENANT_USER_NAME,
                GroupPermission.EDGE_TENANT_USER_PERMISSIONS, "Autogenerated Edge Tenant User role.");
    }

    @Override
    public Role findOrCreateEdgeCustomerAdminRole(TenantId tenantId, CustomerId customerId) {
        return findOrCreateRole(tenantId, customerId, RoleType.GENERIC, Role.ROLE_EDGE_CUSTOMER_ADMIN_NAME,
                GroupPermission.EDGE_CUSTOMER_ADMIN_PERMISSIONS,
                "Autogenerated Edge Customer Administrator role.");
    }

    @Override
    public Role findOrCreateEdgeCustomerUserRole(TenantId tenantId, CustomerId customerId) {
        return findOrCreateRole(tenantId, customerId, RoleType.GENERIC, Role.ROLE_EDGE_CUSTOMER_USER_NAME,
                GroupPermission.EDGE_CUSTOMER_USER_PERMISSIONS,
                "Autogenerated Edge Customer User role.");
    }
