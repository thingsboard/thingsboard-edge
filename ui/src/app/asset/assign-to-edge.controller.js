 ...
 */
/*@ngInject*/
export default function AssignAssetToEdgeController(edgeService, assetService, $mdDialog, $q, assetIds, edges) {
    ...
    function assign() {
        ...
        for (var i=0;i<assetIds.length;i++) {
            tasks.push(assetService.assignAssetToEdge(vm.edges.selection.id.id, assetIds[i]));
        }
