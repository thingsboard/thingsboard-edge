...
/*@ngInject*/
function UserService($http, $q, $rootScope, adminService, dashboardService, timeService, loginService, whiteLabelingService, customTranslationService, toast, store, reportStore, jwtHelper, $translate, $state, $location) {
