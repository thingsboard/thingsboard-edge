 ...
 */
/*@ngInject*/
export default function GroupPermissionDialogController($mdDialog, types, securityTypes, isUserGroup, isAdd, groupPermission,
    ...
    function save() {
        ...
        $mdDialog.hide(vm.groupPermission);
    }
}
