    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "converter": {
                    ...
                    "selected-converters": "{ count, select, 1 {1 data converter} other {# data converters} } selected",
                    ...
                    "delete-converters-title": "Are you sure you want to delete { count, select, 1 {1 data converter} other {# data converters} }?",
                    "delete-converters-action-title": "Delete { count, select, 1 {1 data converter} other {# data converters} }",
                ...
                "dashboard": {
                    ...
                    "export-jpg": "Export as JPEG",
                    "export-json-config": "Export JSON configuration",
                    "download-dashboard-progress": "Generating dashboard {{reportType}} ...",
                ...
                "entity": {
                    ...
                    "type-converter": "Data converter",
                    "type-converters": "Data converters",
                    "list-of-converters": "{ count, select, 1 {One data converter} other {List of # data converters} }",
                    "converter-name-starts-with": "Data converters whose names start with '{{prefix}}'",
                    "type-integration": "Integration",
                    "type-integrations": "Integrations",
                    "list-of-integrations": "{ count, select, 1 {One integration} other {List of # integrations} }",
                    "integration-name-starts-with": "Integrations whose names start with '{{prefix}}'"
                },
                "entity-group": {
                ...
                "integration": {
                    ...
                    "selected-integrations": "{ count, select, 1 {1 integration} other {# integrations} } selected",
                    ...
                    "delete-integrations-title": "Are you sure you want to delete { count, select, 1 {1 integration} other {# integrations} }?",
                    "delete-integrations-action-title": "Delete { count, select, 1 {1 integration} other {# integrations} }",
                ...
                "scheduler": {
                    ...
                    "search-scheduler-events": "Search scheduler events",
                    "created-time": "Created time",
                    "name": "Name",
                    "type": "Type",
                    "assigned_customer": "Assigned customer",
                    "edit-scheduler-event": "Edit scheduler event",
                    "delete-scheduler-event": "Delete scheduler event",
                    "no-scheduler-events": "No scheduler events found",
                    "selected-scheduler-events": "{ count, select, 1 {1 scheduler event} other {# scheduler events} } selected",
                    "delete-scheduler-event-title": "Are you sure you want to delete scheduler event '{{schedulerEventName}}'?",
                    "delete-scheduler-event-text": "Be careful, after the confirmation scheduler event and all related data will become unrecoverable.",
                    "delete-scheduler-events-title": "Are you sure you want to delete { count, select, 1 {1 scheduler event} other {# scheduler events} }?",
                    "delete-scheduler-events-text": "Be careful, after the confirmation all selected scheduler events will be removed and all related data will become unrecoverable.",
                    "create": "Create scheduler event",
                    "edit": "Edit scheduler event",
                    "name-required": "Name is required",
                    "configuration": "Configuration",
                    "schedule": "Schedule",
                    "start": "Start",
                    ...
                    "daily": "Daily",
                    "weekly": "Weekly",
                    "repeats-required": "Repeats is required.",
                    "repeat-on": "Repeat on",
                    "ends-on": "Ends on",
                    "sunday-label": "S",
                    "monday-label": "M",
                    ...
                    "friday-label": "F",
                    "saturday-label": "S",
                    "repeat-on-sunday": "Repeat on Sunday",
                    "repeat-on-monday": "Repeat on Monday",
                    "repeat-on-tuesday": "Repeat on Tuesday",
                    "repeat-on-wednesday": "Repeat on Wednesday",
                    "repeat-on-thursday": "Repeat on Thursday",
                    "repeat-on-friday": "Repeat on Friday",
                    "repeat-on-saturday": "Repeat on Saturday",
                    "event-type": "Event type",
                ...
                "white-labeling": {
                    ...
                    "favicon-size-error": "Website image is too large. Maximum allowed website image size {{kbSize}} KBytes.",
                    "favicon-type-error": "Invalid website image file format. Only ICO, GIF or PNG images are accepted.",
                    "drop-favicon-image": "Drop an website icon image or click to select a file to upload.",
                    "no-favicon-image": "No icon selected",
                    "logo": "Logo",
                    "logo-description": "Any image with maximum size {{kbSize}} KBytes.",
                    "logo-size-error": "Logo image is too large. Maximum allowed logo image size {{kbSize}} KBytes.",
                    "logo-type-error": "Invalid logo file format. Only images are accepted.",
