...
import integrationApachePulsarTemplate from './integration-apache-pulsar.tpl.html';

/* eslint-enable import/no-unresolved, import/default */

/*@ngInject*/
export default function IntegrationApachePulsarDirective($compile, $templateCache, $translate, $mdExpansionPanel, types) {

    var linker = function (scope, element, attrs, ngModelCtrl) {
        var template = $templateCache.get(integrationApachePulsarTemplate);
        ...
        ngModelCtrl.$render = function () {
            ...
            setupApachePulsarConfiguration();
            scope.updateValidity();
        };

        function setupApachePulsarConfiguration() {
