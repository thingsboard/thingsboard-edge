...
import integrationMqttTemplate from './integration-mqtt.tpl.html';

/* eslint-enable import/no-unresolved, import/default */

/*@ngInject*/
export default function IntegrationMqttDirective($compile, $templateCache, $translate, $mdExpansionPanel, types) {
    ...
    var linker = function (scope, element, attrs, ngModelCtrl) {
        ...
        function setupMqttConfiguration() {
            if (!scope.configuration.clientConfiguration) {
                ...
                scope.configuration.clientConfiguration.host = 'localhost';
                scope.configuration.clientConfiguration.port = 11883;
                scope.configuration.clientConfiguration.credentials.type = types.mqttCredentialTypes.anonymous.value;
            }
