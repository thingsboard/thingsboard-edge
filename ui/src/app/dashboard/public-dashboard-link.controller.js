...
/*@ngInject*/
export default function PublicDashboardLinkDialogController($mdDialog, $translate, toast, dashboardService, dashboard, entityGroup) {

        var vm = this;

        vm.dashboard = dashboard;
        vm.publicLink = dashboardService.getPublicDashboardLink(dashboard, entityGroup);
